...
AmCharts.Class=function(c){
    ...
    if(c.inherits){
        b.prototype=new c.inherits(inheriting);
        ...
        b.prototype.createEvents=function(){
            for(var e=0,d=arguments.length;
                e<d;e++){
                this.events[arguments[e]]=[]
            }
            };
            
    b.prototype.listenTo=function(f,e,d){
        f.events[e].push({
            handler:d,
            scope:this
        })
    ...
    b.prototype.addListener=function(e,d,f){
        this.events[e].push({
            handler:d,
            scope:f
        })
    ...
    b.prototype.removeListener=function(h,g,e){
        var f=h.events[g];
...
b.prototype.fire=function(j,k){
    var e=this.events[j];
    for(var f=0,d=e.length;
        f<d;f++){
        var g=e[f];
        g.handler.call(g.scope,k)
    }
    }
}
for(var a in c){
...
AmCharts.removeChart=function(b){
    for(var a=AmCharts.charts.length-1;
        a>=0;a--){
        if(AmCharts.charts[a]==b){
            AmCharts.charts.splice(a,1)
        }
    }
    };
...
if(navigator.appVersion.indexOf("MSIE")!=-1){
    if(document.documentMode){
        AmCharts.IEversion=document.documentMode
    }
}
...
AmCharts.handleMouseUp=function(c){
    for(var a=0;
        a<AmCharts.charts.length;
        a++){
        var b=AmCharts.charts[a];
        if(b){
            b.handleReleaseOutside(c)
        }
    }
    };

AmCharts.handleMouseMove=function(c){
    for(var a=0;
        a<AmCharts.charts.length;
        a++){
        var b=AmCharts.charts[a];
...
AmCharts.AmChart=AmCharts.Class({
    ...
    drawChart:function(){
        ...
        if(this.backgroundColor!=undefined&&this.backgroundAlpha>0){
            this.background=AmCharts.rect(this.container,this.realWidth-1,this.realHeight,this.backgroundColor,this.backgroundAlpha,1,this.borderColor,this.borderAlpha);
    ...
    if(this.legend){
        ...
        switch(b){
            ...
            case"absolute":
                ...
                if(this.legend.left!=undefined){
                    this.legendDiv.style.left=this.legend.left
                }
                if(this.legend.right!=undefined){
                    this.legendDiv.style.right=this.legend.right
                }
                if(this.legend.top!=undefined){
                    this.legendDiv.style.top=this.legend.top
                }
                if(this.legend.bottom!=undefined){
                    this.legendDiv.style.bottom=this.legend.bottom
                }
                this.div.appendChild(this.chartDiv);
                this.div.appendChild(this.legendDiv);
                break;
...
measure:function(){
    this.divRealWidth=this.div.offsetWidth;
    this.divRealHeight=this.div.offsetHeight;
    if(this.div.clientHeight){
        this.divRealWidth=this.div.clientWidth;
    ...
    if(this.realWidth!=this.previousWidth||this.realHeight!=this.previousHeight){
        this.chartDiv.style.width=this.realWidth+"px";
...
destroySets:function(){
    this.set=null;
    if(this.balloon){
        this.balloon.set=null
    }
},
clear:function(){
    if(this.chartScrollbar){
        this.chartScrollbar.clear();
        this.chartScrollbar=null
    }
    if(this.chartCursor){
        this.chartCursor.clear();
...
bringLabelsToFront:function(){
    for(var a=this.labels.length-1;
        a>=0;a--){
        this.labels[a].toFront()
    }
    },
redrawLabels:function(){
    ...
    for(var b=0;b<this.allLabels.length;
        b++){
        var a=this.allLabels[b];
        this.drawLabel(a.x,a.y,a.text,a.align,a.size,a.color,a.rotation,a.alpha,a.bold)
    }
    },
drawLabel:function(j,g,k,e,m,b,l,a,f){
    if(this.container){
        var d=AmCharts.toCoordinate(j,this.realWidth);
        ...
        if(e=="center"){
            e="middle";
            if(!l){
                d=this.realWidth/2-d
            }else{
                c=this.realHeight-c+c/2
            }
        }
        if(a==undefined){
        a=1
    ...
    c+=m/2;
    var h=AmCharts.text(this.container,d,c,k,{
        fill:b,
        "fill-opacity":a,
        "text-anchor":e,
...
addLabel:function(f,e,h,c,k,b,j,a,d){
    if(this.container){
        this.drawLabel(f,e,h,c,k,b,j,a,d)
    }
    var g={
        x:f,
        y:e,
...
updateWidth:function(){
    var d=this.divRealWidth;
    var a=this.divRealHeight;
    if(this.legend){
        var e=Number(this.legendDiv.style.width.replace("px",""));
        var b=Number(this.legendDiv.style.height.replace("px",""));
        var c=this.legend.position;
        if(c=="right"||c=="left"){
            d-=e;
            if(d<0){
                ...
                this.chartDiv.style.width=d+"px";
            if(c=="left"){
                this.chartDiv.style.left=(AmCharts.findPosX(this.div)+e)+"px"
            }else{
                this.legendDiv.style.left=d+"px"
            }
...
addListeners:function(){
    var a=this;
    if(this.touchEventsEnabled&&this.panEventsEnabled){
        this.chartDiv.addEventListener("touchstart",function(b){
            a.handleTouchMove.call(a,b)
        },true);
        this.chartDiv.addEventListener("touchmove",function(b){
            a.handleTouchMove.call(a,b)
        },true);
        this.chartDiv.addEventListener("touchstart",function(b){
            a.handleTouchStart.call(a,b)
        });
        this.chartDiv.addEventListener("touchend",function(b){
            a.handleTouchEnd.call(a,b)
        })
        }else{
        if(AmCharts.isNN){
            this.chartDiv.addEventListener("mousedown",function(b){
                a.handleMouseDown.call(a,b)
            },true);
            this.chartDiv.addEventListener("mouseover",function(b){
                a.handleMouseOver.call(a,b)
            },true);
            this.chartDiv.addEventListener("mouseout",function(b){
                a.handleMouseOut.call(a,b)
            },true)
            }
            if(AmCharts.isIE){
            this.chartDiv.attachEvent("onmousedown",function(b){
                a.handleMouseDown.call(a,b)
            });
            this.chartDiv.attachEvent("onmouseover",function(b){
                a.handleMouseOver.call(a,b)
            });
            this.chartDiv.attachEvent("onmouseout",function(b){
                a.handleMouseOut.call(a,b)
            })
            }
        }
...
drb:function(){
    ...
    e = "amcharts.com";
    if(e!=a){
        a=a+"/?utm_source=swf&utm_medium=demo&utm_campaign=jsDemo";
        var b=this;
        var f=this.container.set();
        var d=AmCharts.rect(this.container,145,20,"#FFFFFF",1);
        var g=AmCharts.text(this.container,2,2,"moc.strahcma yb trahc".split("").reverse().join(""),{
            fill:"#000000",
            "font-family":"Verdana",
            "font-size":11,
            "text-anchor":"start"
...
hideBalloon:function(){
    var a=this;
    this.hoverInt=setTimeout(function(){
...
showBalloon:function(e,c,b,a,f){
    var d=this;
    if(this.balloon.enabled){
        this.balloon.followCursor(false);
        this.balloon.changeColor(c);
        if(!b){
            this.balloon.setPosition(a,f)
        }
...
handleTouchMove:function(c){
    var a;
    var f;
    var d=this.chartDiv;
    if(c.touches){
        var b=c.touches.item(0);
...
handleMouseMove:function(b){
    ...
    if(!isNaN(b.layerX)){
        ...
        if(!isNaN(b.offsetX)&&this.divIsFixed){
        a=b.offsetX;
        c=b.offsetY
        }
    }
if(window.opera){
    if(this.divIsFixed){
        a=b.clientX-AmCharts.findPosX(d);
        c=b.clientY-AmCharts.findPosY(d)
    }else{
        a=b.pageX-AmCharts.findPosX(d);
...
handleResize:function(){
    if(AmCharts.isPercents(this.width)||AmCharts.isPercents(this.height)){
        this.invalidateSize()
    }
}
});
...
AmCharts.toBoolean=function(b,a){
    if(b==undefined){
        return a
    }
...
AmCharts.formatMilliseconds=function(d,c){
    if(d.indexOf("fff")!=-1){
        var b=c.getMilliseconds();
        var a=String(b);
        if(b<10){
            a="00"+b
        }
...
AmCharts.toColor=function(c){
    ...
    return c
},AmCharts.toSvgColor=function(a,d){
    if(typeof(a)=="object"){
        if(d==undefined){
            d=90
        }
...
AmCharts.toCoordinate=function(c,a,b){
    var d;
    if(c!=undefined){
        c=c.toString();
        if(b){
        ...
        d=Number(c);
    if(c.indexOf("!")!=-1){
        d=a-Number(c.substr(1))
    }
    if(c.indexOf("%")!=-1){
        d=a*Number(c.substr(0,c.length-1))/100
    }
}
return d
};

AmCharts.fitToBounds=function(c,b,a){
    if(c<b){
        c=b
    }
    if(c>a){
...
AmCharts.extractPeriod=function(c){
    var a=AmCharts.stripNumbers(c);
    var b=1;
    if(a!=c){
        b=Number(c.slice(0,c.indexOf(a)))
    }
    return{
        period:a,
        count:b
...
AmCharts.resetDateToMin=function(a,f,d){
    var g;
    var e;
    var h;
    var j;
    ...
    switch(f){
        case"YYYY":
            g=Math.floor(a.getFullYear()/d)*d;
            e=0;
            h=1;
            j=0;
            c=0;
        ...
        case"fff":
            ...
            c=a.getMinutes();
            k=a.getSeconds();
            b=Math.floor(a.getMilliseconds()/d)*d;
            break
            }
            a=new Date(g,e,h,j,c,k,b);
    return a
    };
    
AmCharts.getPeriodDuration=function(c,a){
    if(a==undefined){
        a=1
    }
    var b;
...
AmCharts.getMaxInterval=function(c,a){
    var b=AmCharts.intervals;
    if(c>=b[a].contains){
        c=Math.round(c/b[a].contains);
        a=b[a].nextInterval;
        return AmCharts.getMaxInterval(c,a)
    }else{
        if(a=="ss"){
            return b[a].nextInterval
        }else{
            return a
            }
        }
...
AmCharts.formatDuration=function(c,a,k,f,b,g){
    var e=AmCharts.intervals;
    var j=g.decimalSeparator;
    if(c>=e[a].contains){
        var h=c-Math.floor(c/e[a].contains)*e[a].contains;
        if(a=="ss"){
            h=AmCharts.formatNumber(h,g);
            if(h.split(j)[0].length==1){
                h="0"+h
            }
        }
        if((a=="mm"||a=="hh")&&h<10){
    ...
    k=h+""+f[a]+""+k;
    c=Math.floor(c/e[a].contains);
    a=e[a].nextInterval;
    return(AmCharts.formatDuration(c,a,k,f,b,g))
}else{
    if(a=="ss"){
        c=AmCharts.formatNumber(c,g);
        if(c.split(j)[0].length==1){
            c="0"+c
        }
    }
    if((a=="mm"||a=="hh")&&c<10){
...
AmCharts.formatNumber=function(c,j,g,e,m){
    c=AmCharts.roundTo(c,j.precision);
    if(isNaN(g)){
        g=j.precision
    }
    ...
    if(k.indexOf("e")==-1){
        ...
        for(var b=d.length;b>=0;
            ...
            if(b!=d.length){
                if(b!=0){
                    l=d.substring(b-3,b)+h+l
                }else{
                    l=d.substring(b-3,b)+l
                }
            }else{
            l=d.substring(b-3,b)
        }
...
if(g!=undefined&&g>0&&l!="0"){
    l=AmCharts.addZeroes(l,n,g)
}
}else{
    l=k
    }
...
AmCharts.addZeroes=function(b,c,a){
    var d=b.split(c);
    if(d[1]==undefined&&a>0){
        d[1]="0"
    }
    if(d[1].length<a){
        d[1]=d[1]+"0";
...
AmCharts.scientificToNormal=function(b){
    var f=b.toString();
    var e;
    var a=f.split("e");
    if(a[1].substr(0,1)=="-"){
...
AmCharts.toScientific=function(b,d){
    if(b==0){
        return"0"
    }
...
AmCharts.generateGradient=function(a,e,c){
    var d=e;
    if(c){
        for(var b=c.length-1;
            b>=0;b--){
            d+="-"+AmCharts.adjustLuminosity(a,c[b]/100)
        }
        }else{
    if(typeof(a)=="object"){
        if(a.length>1){
...
AmCharts.hitTest=function(g,e,h){
    var f=false;
    var b=g.x;
    var a=g.x+g.width;
    var d=g.y;
    var c=g.y+g.height;
    if(!f){
        f=AmCharts.isInRectangle(b,d,e)
    }
    if(!f){
        f=AmCharts.isInRectangle(b,c,e)
    }
    if(!f){
        f=AmCharts.isInRectangle(a,d,e)
    }
    if(!f){
        f=AmCharts.isInRectangle(a,c,e)
    }
    if(!f&&h!=true){
        f=AmCharts.hitTest(e,g,true)
    }
    return f
    };
    
AmCharts.isInRectangle=function(a,c,b){
    if(a>=b.x&&a<=b.x+b.width&&c>=b.y&&c<=b.y+b.height){
        return true
    }else{
        return false
        }
...
AmCharts.formatDate=function(x,u){
    var j=x.getFullYear();
...
AmCharts.formatString=function(a,b,d,c){
    a=a.replace(/<br>/g,"\n");
    if(b.value!=undefined){
        a=a.replace(/\[\[value\]\]/g,AmCharts.formatNumber(b.value,d))
    }
    if(b.open!=undefined){
        a=a.replace(/\[\[open\]\]/g,AmCharts.formatNumber(b.open,d))
    }
    if(b.close!=undefined){
        a=a.replace(/\[\[close\]\]/g,AmCharts.formatNumber(b.close,d))
    }
    if(b.low!=undefined){
        a=a.replace(/\[\[low\]\]/g,AmCharts.formatNumber(b.low,d))
    }
    if(b.high!=undefined){
        a=a.replace(/\[\[high\]\]/g,AmCharts.formatNumber(b.high,d))
    }
    if(b.percents!=undefined){
        a=a.replace(/\[\[percents\]\]/g,AmCharts.formatNumber(b.percents,c))
    }
    if(b.title!=undefined){
        a=a.replace(/\[\[title\]\]/g,b.title)
    }else{
        a=a.replace(/\[\[title\]\]/g,"")
    }
    if(b.category!=undefined){
        a=a.replace(/\[\[category\]\]/g,b.category)
    }else{
        a=a.replace(/\[\[category\]\]/g,"")
    }
    if(b.graphTitle!=undefined){
        a=a.replace(/\[\[graphTitle\]\]/g,b.graphTitle)
    }else{
        a=a.replace(/\[\[graphTitle\]\]/g,"")
    }
    if(b.description!=undefined){
        a=a.replace(/\[\[description\]\]/g,b.description)
    }else{
        a=a.replace(/\[\[description\]\]/g,"")
    }
    return a
    };
    
AmCharts.addPrefix=function(j,k,e,f){
    var h=AmCharts.formatNumber(j,f);
    var d="";
    var g;
    var b;
    var a;
...
AmCharts.removeSet=function(e){
    if(e){
        for(var a=0;
            a<e.length;a++){
            var d=e[a];
            if(d.length>0){
                AmCharts.removeSet(d)
            }
            var c=d.clip;
            var b=d.node;
            if(b){
...
AmCharts.Bezier=AmCharts.Class({
    construct:function(a,p,m,g,f,o,c,d,b,r){
        if(typeof(c)=="object"){
            c=c[0]
        }
        if(typeof(d)=="object"){
        ...
        if(q.length>1){
            var k=this.interpolate(q);
            this.drawBeziers(k)
            }
            this.lineArray=this.lineArray.concat(r);
        this.path=a.path(this.lineArray).attr(j)
    },
    interpolate:function(l){
        var j=[];
        j.push({
            x:l[0].x,
            y:l[0].y
        ...
        j.push({
            x:l[l.length-1].x-e/b,
            y:l[l.length-1].y-c/6
            });
        j.push({
            x:l[l.length-1].x,
            y:l[l.length-1].y
    ...
    drawBeziers:function(b){
        for(var a=0;
            a<(b.length-1)/3;a++){
            this.drawBezierMidpoint(b[3*a],b[3*a+1],b[3*a+2],b[3*a+3])
        }
        },
drawBezierMidpoint:function(c,b,o,l){
    var f=this.getPointOnSegment(c,b,3/4);
    ...
    h.x-=p;
    h.y-=m;
    var g=this.getPointOnSegment(d,f,3/8);
    g.x+=p;
    g.y+=m;
    var e=this.getPointOnSegment(l,o,3/8);
...
getPointOnSegment:function(c,b,d){
    var a={
        x:c.x+(b.x-c.x)*d,
        y:c.y+(b.y-c.y)*d
        };
...
AmCharts.Cuboid=AmCharts.Class({
    construct:function(b,d,m,o,n,a,f,e,h,g,l,j){
        this.set=b.set();
        this.container=b;
        this.h=m;
        this.w=d;
    ...
    draw:function(){
        this.set.remove();
        var t=0;
        var m=Math.abs(this.w);
        var s=Math.abs(this.h);
        var n=this.dx;
        var l=this.dy;
        if(this.dx>0||l>0){
            var c=this.colors[this.colors.length-1];
            if(this.h>0){
                c=this.colors[0]
            }
            ...
            this.set.push(o);
            var b=AmCharts.line(this.container,[0,n,m+n],[0,l,l],this.bcolor,this.balpha,this.bwidth);
            this.set.push(b);
            var d=AmCharts.adjustLuminosity(this.colors[0],-0.2);
            if(s>0&&m>0){
                ...
                this.set.push(k);
                var r=AmCharts.polygon(this.container,[0,0,n,n,0],[0,-s,-s+l,l,0],d,this.alpha,0,0,0,this.gradientRotation);
                this.set.push(r);
                var j=AmCharts.polygon(this.container,[0,0,n,n,0],[0,-s,-s+l,l,0],d,this.alpha,0,0,0,this.gradientRotation);
                j.translate(m+","+0);
                this.set.push(j);
                var f=AmCharts.line(this.container,[0,n,n,0],[-s,-s+l,l,0],this.bcolor,this.balpha,this.bwidth);
                this.set.push(f);
                f.translate(m+","+0)
            }
            var e=this.colors[0];
            ...
            p.translate(0+","+(-s));
            this.set.push(p);
            var a=AmCharts.line(this.container,[0,n,m+n],[0,l,l],this.bcolor,this.balpha,this.bwidth);
            a.translate(0+","+(-s));
            this.set.push(a)
            }
            this.front=AmCharts.rect(this.container,m,s,this.colors,this.alpha,this.bwidth,this.bcolor,this.balpha,this.cornerRadius,this.gradientRotation);
    ...
    y:function(a){
        ...
        if(this.h<0){
            this.set.translate(0+","+a)
        }else{
            this.set.translate(0+","+(a+this.h))
        }
    },
x:function(a){
    a=Math.round(a*10)/10;
    if(this.w<0){
        this.set.translate((a+this.w)+","+0)
    }else{
        this.set.translate(a+","+0)
    }
},
width:function(a){
    this.w=a;
...
drawLegend:function(){
    ...
    if(this.width!=undefined){
        this.divWidth=AmCharts.toCoordinate(this.width,this.chart.realWidth)
    }else{
        this.divWidth=this.chart.realWidth
    }
    ...
    for(var a=0;
        ...
        this.createEntry(this.data[a])
    }
    this.index=0;
    for(var a=0;
        a<this.data.length;a++){
        this.createValue(this.data[a])
    }
    this.arrangeEntries();
    this.updateValues()
    },
arrangeEntries:function(){
    w=this.divWidth-this.marginRight-this.marginLeft;
    var q=0;
    var o=0;
    for(var p=0;
        p<this.entries.length;
        p++){
        var a=this.entries[p].getBBox();
        var r=a.width;
        if(r>q){
            q=r
        }
...
this.set=this.container.set();
    for(var p=0;p<this.entries.length;
        p++){
        var c=this.entries[p];
        if(this.reversedOrder){
            c=this.entries[this.entries.length-p-1]
        }
        var a=c.getBBox();
        var m=(this.horizontalGap+d*(q+this.spacing+this.markerLabelGap));
        if(m+a.width>w&&p>0){
            k++;
            d=0;
            m=this.horizontalGap
        }
        var l=this.verticalGap+(o+this.verticalGap)*k;
        c.translate(m+","+l);
        d++;
        if(!isNaN(this.maxColumns)){
            if(d>=this.maxColumns){
                d=0;
                k++
            }
        }
...
if(this.position=="left"||this.position=="right"){
    var s=this.set.getBBox().width+2*this.horizontalGap;
    var b=s+this.marginLeft+this.marginRight;
    this.div.style.width=b+"px"
}else{
    var s=this.divWidth-this.marginLeft-this.marginRight
}
...
if(this.position=="top"||this.position=="bottom"){
    ...
    if(this.align=="center"){
        this.set.translate(((s-(this.set.getBBox().width))/2)+","+0)
    }
}
var n=g+this.marginTop+this.marginBottom;
this.div.style.height=n+"px"
},
createEntry:function(h){
    if(h.visibleInLegend!==false){
        var g=h.markerType;
        if(!g){
            g=this.markerType
        }
...
var a=this;
if(this.chart.touchEventsEnabled){
    k.touchend(function(){
        a.clickMarker(this.dItem)
    });
    k.touchstart(function(){
        a.rollOverMarker(this.dItem)
    })
    }else{
    k.hover(function(){
        a.rollOverMarker(this.dItem)
    },function(){
        a.rollOutMarker(this.dItem)
    }).click(function(){
        a.clickMarker(this.dItem)
    })
    }
    var n=this.color;
if(h.showBalloon&&this.textClickEnabled&&this.selectedColor!=undefined){
...
if(d){
    var l=AmCharts.text(this.container,this.markerSize+this.markerLabelGap,this.markerSize/2,d,{
        fill:n,
        "text-anchor":"start",
        "font-family":this.chart.fontFamily,
        "font-size":p
    });
    var m=l.getBBox();
    lWidth=m.width;
    if(this.maxLabelWidth<lWidth){
        this.maxLabelWidth=lWidth
    }
}
...
rollOverMarker:function(a){
    if(this.switchable){
        this.dispatch("rollOverMarker",a)
    }else{
...
rollOutLabel:function(b){
    if(!b.hidden){
        if(b.legendLabel){
            var a=this.color;
            if(this.selectedColor!=undefined&&b.showBalloon){
                a=this.selectedColor
            }
            b.legendLabel.attr({
                fill:a
            })
...
createValue:function(d){
    if(d.visibleInLegend!==false){
        ...
        if(this.valueText){
            ...
            var h=AmCharts.text(this.container,f,this.markerSize/2,b,{
                fill:g,
                "text-anchor":"end",
                "font-family":this.chart.fontFamily,
                "font-size":j
            ...
            h.dItem=d;
            this.valueLabels.push(h)
        }
        this.index++;
        var e=this.container.rect(this.markerSize+this.markerLabelGap,0,c,this.markerSize).attr({
            stroke:"none",
            fill:"#FFCCFF",
            "fill-opacity":0
        });
        e.dItem=d;
        this.entries[this.index-1].push(e);
        var a=this;
        e.mouseover(function(){
            a.rollOverLabel(this.dItem)
        }).mouseout(function(){
            a.rollOutLabel(this.dItem)
        }).click(function(){
            a.clickLabel(this.dItem)
        })
        }
    },
createV:function(){
...
createMarker:function(f,d,h){
    var e=this.markerSize;
    var j=this.container;
    var b;
    var g=this.markerBorderColor;
    if(!g){
        g=d
        }
        var a={
    ...
    switch(f){
        case"square":
            b=j.rect(0,0,e,e).attr(a);
            break;
        case"circle":
            b=j.circle(e/2,e/2,e/2).attr(a);
            break;
        case"line":
            b=j.path(["M",0,e/2,"L",e,e/2]).attr({
            stroke:d,
            "stroke-width":this.markerBorderThickness
            });
        break;
        case"dashedLine":
            b=j.path(["M",0,e/2,"L",e/2-2,e/2,"M",e/2+2,e/2,"L",e,e/2]).attr({
            stroke:d,
            "stroke-width":this.markerBorderThickness
            });
        break;
        case"triangleUp":
            b=j.path(["M",0,e,"L",e/2,0,"L",e,e,"L",0,e,"Z"]).attr(a);
            break;
        case"triangleDown":
            b=j.path(["M",0,0,"L",e/2,e,"L",e,0,"L",0,0,"Z"]).attr(a);
            break;
        case"bubble":
            a.fill=NaN;
...
updateValues:function(){
    for(var f=0;
        ...
        f++){
        var e=this.valueLabels[f];
        var d=e.dItem;
        if(d.type!=undefined){
            if(d.currentDataItem){
                var h=this.valueText;
                if(d.legendValueText){
                    h=d.legendValueText
                }
        ...
        var a=AmCharts.formatString(this.valueText,d,this.chart.numberFormatter,this.chart.percentFormatter);
        e.attr({
            text:a
        })
        }
...
AmCharts.AmBalloon=AmCharts.Class({
    ...
    draw:function(){
        ...
        if(!isNaN(E)){
            ...
            if(this.show){
                ...
                if(G!=undefined){
                    if(this.adjustBorderColor){
                        c=G
                    }else{
                        m=G
                        }
                    }
                var C=this.horizontalPadding;
            ...
            var u=this.fontSize;
            if(u==undefined){
                u=this.chart.fontSize
            }
            var z=AmCharts.text(t,0,0,this.text,{
                fill:this.color,
                "font-family":B,
                "font-size":u
            });
            this.set.push(z);
            if(p!=undefined){
                var l=AmCharts.text(t,1,1,this.text,{
                    fill:p,
                    opacity:0.4,
                    "font-family":B,
                    "font-size":u
    ...
    if(g+r>q){
        ...
        var j;
    if(d>0){
        j=AmCharts.rect(t,r,A,[m],[this.fillAlpha],this.borderThickness,c,this.borderAlpha,this.cornerRadius);
        if(this.showBullet){
            var y=AmCharts.circle(t,3,m,this.fillAlpha);
            y.translate(E+","+D)
            }
        }else{
    var o=[];
    ...
    if(k!="horizontal"){
        ...
        if(D<a+(n-a)/2&&k!="down"){
            v=[0,0,D-f+1,0,0,A,A,0]
        }else{
            v=[A,A,D-f-1,A,A,0,0,A]
        }
    }else{
    var F=D-f;
    if(F>A-x){
...
followMouse:function(){
    if(this.follow&&this.show){
        var c=this.chart.mouseX;
        var b=this.chart.mouseY;
        this.pointToX=c;
        this.pointToY=b;
        if(c!=this.previousX||b!=this.previousY){
            this.previousX=c;
            this.previousY=b;
...
setPosition:function(a,c,b){
    ...
    this.pointToY=c;
    if(b){
        if(a!=this.previousX||c!=this.previousY){
            this.draw()
        }
    }
    this.previousX=a;
...
followCursor:function(a){
    this.follow=a;
    if(a){
        this.pShowBullet=this.showBullet;
        this.showBullet=false
    }else{
        if(this.pShowBullet!=undefined){
            this.showBullet=this.pShowBullet
        }
    }
    clearInterval(this.interval);
if(!isNaN(this.chart.mouseX)){
    if(a){
        this.pointToX=this.chart.mouseX;
...
AmCharts.AmCoordinateChart=AmCharts.Class({
    ...
    initChart:function(){
        ...
        if(this.valueAxes.length==0){
            ...
            if(this.legend){
            this.legend.setData(this.graphs)
        }
    },
parseData:function(){
...
parseSerialData:function(){
    ...
    if(this.dataProvider){
        ...
        if(this.categoryAxis){
            g=this.categoryAxis.parseDates
        }
        if(g){
            var u=AmCharts.extractPeriod(this.categoryAxis.minPeriod);
            var l=u.period;
            var d=u.count
        }
        for(var q=0;q<f;q++){
            ...
            for(var p=0;p<e;
                ...
                for(var o=0;
                    ...
                    if(graph.valueAxis.id==s){
                        ...
                        r.values=b;
                        this.processFields(graph,r,c);
                        r.category=String(t.category);
                        r.serialDataItem=t;
                        r.graphTitle=graph.title;
                        t.axes[s].graphs[m]=r
                    }
                }
                }
...
removeValueAxesAndGraphs:function(){
    for(var a=this.valueAxes.length-1;
        a>-1;a--){
        this.removeValueAxis(this.valueAxes[a])
    }
    },
removeValueAxis:function(d){
...
for(a=b-1;a>=0;a--){
    if(this.valueAxes[a]==d){
        this.valueAxes.splice(a,1)
    }
}
this.validateData()
},
...
removeGraph:function(c){
    var b=this.graphs.length;
    for(var a=b-1;a>=0;a--){
        if(this.graphs[a]==c){
            this.graphs.splice(a,1);
            c.destroy()
            }
        }
    this.validateData()
...
processValueAxes:function(){
    for(var a=0;
        ...
        if(this.usePrefixes===true||this.usePrefixes===false){
            b.usePrefixes=this.usePrefixes
        }
    }
    },
...
formatString:function(j,f){
    var c=f.serialDataItem;
    if(this.categoryAxis){
        if(this.categoryAxis.parseDates){
            var h=this.balloonDateFormat;
            if(this.chartCursor){
                h=this.chartCursor.categoryBalloonDateFormat
            }
            if(j.indexOf("[[category]]")!=-1){
                var g=AmCharts.formatDate(c.category,h);
                var e=AmCharts.formatDate(c.category,h);
                if(e.indexOf("fff")!=-1){
                    e=AmCharts.formatMilliseconds(g,c.category)
                }
...
if(c){
    j=j.replace(/\[\[category\]\]/g,c.category)
}
var a=graph.valueAxis;
if(a.duration){
    if(f.values.value){
        var d=AmCharts.formatDuration(f.values.value,a.duration,"",a.durationUnits,a.maxInterval,a.numberFormatter);
...
chooseGraphColor:function(c,b){
    if(c.lineColor==undefined){
        var a;
        if(this.colors.length-1>b){
            a=this.colors[b]
        }else{
            a=AmCharts.randomColor()
        }
        c.lineColor=a
        }
    },
handleLegendEvent:function(d){
    ...
    if(b){
        ...
        switch(c){
            case"clickMarker":
                if(a){
                this.hideGraphsBalloon(b)
            }else{
                this.showGraphsBalloon(b)
            }
            break;
            case"clickLabel":
                if(a){
...
highlightGraph:function(a){
    ...
    var d;
    if(this.legend){
        e=this.legend.rollOverGraphAlpha
    }
    for(b=0;b<c;b++){
        d=this.graphs[b];
        if(d!=a){
...
destroySets:function(){
    AmCharts.AmCoordinateChart.base.destroySets.call(this);
    if(this.graphs){
        for(var a=0;
            a<this.graphs.length;
            a++){
            this.graphs[a].set=null
        }
        }
        if(this.valueAxes){
    for(var a=0;
    ...
    drawChart:function(){
        ...
        if(this.chartData){
            if(this.chartData.length>0){
                if(this.chartCursor){
                    this.chartCursor.draw()
                }
                if(this.zoomOutText!=""&&this.zoomOutText){
                    this.drawZoomOutButton()
                }
            }
        }
},
drawZoomOutButton:function(){
    ...
    if(this.zoomOutButton){
        if(this.zoomOutButton.fontSize){
            k=this.zoomOutButton.fontSize
        }
        if(this.zoomOutButton.color){
            b=this.zoomOutButton.color
        }
    }
    var g=AmCharts.text(this.container,29,8,this.zoomOutText,{
    fill:b,
    "font-family":this.fontFamily,
    "font-size":k,
    "text-anchor":"start"
...
g.toFront();
d.hide();
this.zoomOutButtonBG=d;
this.lens=f;
this.zoomOutButtonSet.push(d);
...
if(this.touchEventsEnabled){
    this.zoomOutButtonSet.touchstart(function(){
        a.rollOverZB()
    }).touchend(function(){
        a.clickZB()
    })
    }
    this.zoomOutButtonSet.mouseover(function(){
    a.rollOverZB()
}).mouseout(function(){
    a.rollOutZB()
}).click(function(){
...
drawPlotArea:function(){
    ...
    if(n!=0&&m!=0){
        ...
        l.translate(a+","+(j+e));
        this.set.push(l);
        var g=this.container.path(["M",0,0,"L",0,e,"L",n,e+m,"L",n,m,"L",0,0,"Z"]).attr(f);
        g.translate(a+","+j);
        this.set.push(g)
        }
    },
...
addChartCursor:function(a){
    if(this.chartCursor){
        this.chartCursor.destroy()
    }
    this.chartCursor=a;
    if(this.chartCursor){
        this.listenTo(this.chartCursor,"changed",this.handleCursorChange);
...
addChartScrollbar:function(a){
    if(this.chartScrollbar){
        this.chartScrollbar.destroy()
    }
    this.chartScrollbar=a;
    if(this.chartScrollbar){
        this.chartScrollbar.chart=this;
        this.listenTo(this.chartScrollbar,"zoomed",this.handleScrollbarZoom)
    }
    if(this.rotate){
        if(this.chartScrollbar.width==undefined){
            this.chartScrollbar.width=this.chartScrollbar.scrollbarHeight
        }
    }else{
    if(this.chartScrollbar.height==undefined){
        this.chartScrollbar.height=this.chartScrollbar.scrollbarHeight
    }
}
},
...
handleReleaseOutside:function(a){
    ...
    if(this.chartScrollbar){
        this.chartScrollbar.handleReleaseOutside()
    }
    if(this.chartCursor){
        this.chartCursor.handleReleaseOutside()
    }
},
handleMouseDown:function(a){
    AmCharts.AmRectangularChart.base.handleMouseDown.call(this,a);
    if(this.chartCursor){
        this.chartCursor.handleMouseDown(a)
    }
},
destroySets:function(){
    AmCharts.AmRectangularChart.base.destroySets.call(this);
    if(this.chartCursor){
        this.chartCursor.set=null
    }
    if(this.chartScrollbar){
        this.chartScrollbar.set=null
    }
}
});
AmCharts.AmSerialChart=AmCharts.Class({
    ...
    drawChart:function(){
        ...
        if(d){
            if(d.length>0){
                if(this.chartScrollbar){
                    this.chartScrollbar.draw()
                }
                var b=d.length-1;
                var c;
                var a;
                if(this.categoryAxis.parseDates&&!this.categoryAxis.equalSpacing){
                    c=this.startTime;
                    a=this.endTime;
                    if(isNaN(c)||isNaN(a)){
                        c=d[0].time;
...
this.bringLabelsToFront();
    ...
    if(this.dispatchDataUpdated){
        this.dispatchDataUpdated=false;
...
cleanChart:function(){
    for(var a=0;
        a<this.valueAxes.length;
        a++){
        this.valueAxes[a].destroy()
    }
    for(var a=0;a<this.graphs.length;
        a++){
        this.graphs[a].destroy()
    }
    if(this.categoryAxis){
        this.categoryAxis.destroy()
    }
    if(this.chartCursor){
        this.chartCursor.destroy()
    }
...
updateCategoryAxis:function(){
    this.categoryAxis.id="categoryAxis";
    ...
    if(this.rotate){
        this.categoryAxis.orientation="vertical"
    }else{
        this.categoryAxis.orientation="horizontal"
    }
...
updateValueAxes:function(){
    ...
    for(var a=0;a<b;a++){
        var c=this.valueAxes[a];
        if(!this.categoryAxis.startOnAxis||this.categoryAxis.parseDates){
            c.expandMinMax=true
        }
    }
    },
...
updateMargins:function(){
    ...
    if(this.chartScrollbar){
        if(this.rotate){
            this.scrollbarHeight=this.chartScrollbar.width
        }else{
            this.scrollbarHeight=this.chartScrollbar.height
        }
        if(this.rotate){
            if(this.categoryAxis.position=="bottom"||this.categoryAxis.position=="left"){
                this.scrollbarPosition="bottom"
            }else{
                this.scrollbarPosition="top"
            }
        }else{
        if(this.categoryAxis.position=="top"||this.categoryAxis.position=="right"){
            this.scrollbarPosition="bottom"
        }else{
            this.scrollbarPosition="top"
        }
    ...
    if(this.rotate){
        this.marginLeftReal+=this.scrollbarHeight
    }else{
        this.marginTopReal+=this.scrollbarHeight
    }
}else{
    if(this.rotate){
        this.marginRightReal+=this.scrollbarHeight
    }else{
        this.marginBottomReal+=this.scrollbarHeight
    }
}
}
},
updateScrollbars:function(){
    if(this.chartScrollbar){
        if(this.scrollbarPosition=="top"){
            if(this.rotate){
                this.chartScrollbar.y=this.marginTopReal;
                this.chartScrollbar.x=this.marginLeftReal-this.scrollbarHeight
            }else{
                this.chartScrollbar.y=this.marginTopReal-this.scrollbarHeight+this.dy;
                this.chartScrollbar.x=this.marginLeftReal+this.dx
            }
        }else{
        if(this.rotate){
            this.chartScrollbar.y=this.marginTopReal+this.dy;
            this.chartScrollbar.x=this.marginLeftReal+this.plotAreaWidth+this.dx
        }else{
            this.chartScrollbar.y=this.marginTopReal+this.plotAreaHeight+1;
            this.chartScrollbar.x=this.marginLeft
        }
    }
    if(this.rotate){
    this.chartScrollbar.height=this.plotAreaHeight
}else{
    this.chartScrollbar.width=this.plotAreaWidth
}
...
timeZoom:function(b,a){
    if(!isNaN(this.maxSelectedTime)){
        if(a!=this.endTime){
            if(a-b>this.maxSelectedTime){
                b=a-this.maxSelectedTime;
                this.updateScrollbar=true
            }
        }
        if(b!=this.startTime){
        if(a-b>this.maxSelectedTime){
            a=b+this.maxSelectedTime;
            this.updateScrollbar=true
        }
    }
}
if(this.chartData){
    if(this.chartData.length>0){
        if(b!=this.startTime||a!=this.endTime){
            var c=this.categoryAxis.minDuration();
            this.firstTime=this.chartData[0].time;
            this.lastTime=this.chartData[this.chartData.length-1].time;
            if(!b){
                b=this.firstTime;
                if(!isNaN(this.maxSelectedTime)){
                    b=this.lastTime-this.maxSelectedTime
                }
            }
            if(!a){
            a=this.lastTime
        ...
        this.zoomScrollbar();
        if(b!=this.firstTime||a!=this.lastTime){
            if(this.zoomOutButtonSet){
...
indexZoom:function(c,a){
    if(!isNaN(this.maxSelectedSeries)){
        if(a!=this.end){
            if(a-c>this.maxSelectedSeries){
                c=a-this.maxSelectedSeries;
                this.updateScrollbar=true
            }
        }
        if(c!=this.start){
        if(a-c>this.maxSelectedSeries){
            a=c+this.maxSelectedSeries;
            this.updateScrollbar=true
        }
    }
}
if(c!=this.start||a!=this.end){
    var b=this.chartData.length-1;
    if(isNaN(c)){
        c=0;
        if(!isNaN(this.maxSelectedSeries)){
            c=b-this.maxSelectedSeries
        }
    }
    if(isNaN(a)){
    a=b
...
this.zoomAxesAndGraphs();
this.zoomScrollbar();
if(c!=0||a!=this.dataProvider.length-1){
    if(this.zoomOutButtonSet){
        this.zoomOutButtonSet.show();
        this.zoomOutButtonBG.hide()
    }
...
updateDepths:function(){
    this.mostFrontObj=this.container.rect(0,0,10,10);
    this.updateColumnsDepth();
    var d=this.graphs.length;
    for(var c=0;c<d;c++){
        var e=this.graphs[c];
        if(e.type!="column"){
            e.set.insertBefore(this.mostFrontObj)
        }
        if(e.allBullets){
            for(var b=0;
                b<e.allBullets.length;
                b++){
                e.allBullets[b].insertBefore(this.mostFrontObj)
            }
            }
            if(e.positiveObjectsToClip){
        for(var b=0;
            b<e.positiveObjectsToClip.length;
            b++){
            e.setPositiveClipRect(e.positiveObjectsToClip[b])
        }
        }
        if(e.negativeObjectsToClip){
        for(var b=0;
            b<e.negativeObjectsToClip.length;
            b++){
            e.setNegativeClipRect(e.negativeObjectsToClip[b])
        }
        }
...
if(f){
    for(var b=0;b<f.length;
        b++){
        e.addClickListeners(f[b]);
        if(!this.chartCursor){
            e.addHoverListeners(f[b])
        }
    }
    }
}
if(this.chartCursor){
    this.chartCursor.set.insertBefore(this.mostFrontObj)
}
if(this.zoomOutButtonSet){
    this.zoomOutButtonSet.insertBefore(this.mostFrontObj)
}
d=this.valueAxes.length;
for(var c=0;c<d;c++){
    var g=this.valueAxes[c];
    g.axisLine.set.toFront();
    if(g.grid0){
        AmCharts.putSetToFront(g.grid0)
    }
    AmCharts.putSetToFront(g.axisLine.set);
    for(var b=0;b<g.allLabels.length;
        b++){
        g.allLabels[b].toFront()
    }
    }
...
for(b=0;b<f;b++){
    this.columnsArray[b].column.set.insertBefore(this.mostFrontObj)
}
},
...
zoomScrollbar:function(){
    if(this.chartScrollbar){
        if(this.updateScrollbar){
            if(this.categoryAxis.parseDates&&!this.categoryAxis.equalSpacing){
                this.chartScrollbar.timeZoom(this.startTime,this.endTime)
            }else{
                this.chartScrollbar.zoom(this.start,this.end)
            }
            this.updateScrollbar=true
        }
    }
...
zoomAxesAndGraphs:function(){
    ...
    if(this.chartCursor){
        this.chartCursor.zoom(this.start,this.end,this.startTime,this.endTime)
    }
},
    ...
    for(var d=0;d<k;
        ...
        if(e=="100%"||e=="regular"){
            ...
            for(c=0;c<b;c++){
                h=this.graphs[c];
                if(!h.hidden){
                    if(h.valueAxis==a&&h.type=="column"){
                        if(!g&&h.stackable){
                            f++;
                            g=true
                            }
...
getCategoryIndexByValue:function(d){
    var c=this.chartData.length;
    var a;
    for(var b=0;b<c;
        b++){
        if(this.chartData[b].category==d){
            a=b
        }
    }
    return a
...
handleCursorChange:function(a){
    this.dispatchCursorEvent(a.index)
},
        ...
        if(this.chartData){
            if(this.chartData.length>0){
                if(!isNaN(this.start)&&!isNaN(this.end)){
                    ...
                    a.startIndex=this.start;
                    a.endIndex=this.end;
                    a.startValue=this.chartData[this.start].category;
                    a.endValue=this.chartData[this.end].category;
                    if(this.categoryAxis.parseDates){
                        this.startTime=this.chartData[this.start].time;
...
dispatchCursorEvent:function(c){
    var e=this.graphs.length;
    for(var d=0;d<e;d++){
        var f=this.graphs[d];
        if(isNaN(c)){
            f.currentDataItem=undefined
        }else{
...
getClosestIndex:function(j,f,g,c,a,b){
    if(a<0){
        a=0
    }
    if(b>j.length-1){
...
if(g==k){
    ...
    if(g<k){
        return this.getClosestIndex(j,f,g,c,a,e)
    }else{
        return this.getClosestIndex(j,f,g,c,e,b)
    }
}
},
zoomToIndexes:function(b,a){
    this.updateScrollbar=true;
    if(this.chartData){
        if(this.chartData.length>0){
            if(b<0){
            ...
            if(a>this.chartData.length-1){
                a=this.chartData.length-1
            }
            if(this.categoryAxis.parseDates&&!this.categoryAxis.equalSpacing){
                this.zoom(this.chartData[b].time,this.chartData[a].time)
            }else{
                this.zoom(b,a)
                }
            }
...
zoomToDates:function(d,a){
    this.updateScrollbar=true;
    if(this.categoryAxis.equalSpacing){
        var c=this.getClosestIndex(this.chartData,"time",d.getTime(),true,0,this.chartData.length);
        var b=this.getClosestIndex(this.chartData,"time",a.getTime(),false,0,this.chartData.length);
        this.zoom(c,b)
        }else{
        this.zoom(d.getTime(),a.getTime())
    }
},
zoomToCategoryValues:function(b,a){
    this.updateScrollbar=true;
    this.zoom(this.getCategoryIndexByValue(b),this.getCategoryIndexByValue(a))
},
destroySets:function(){
    AmCharts.AmSerialChart.base.destroySets.call(this);
    if(this.categoryAxis){
        this.categoryAxis.set=null
    }
}
});
...
removeGuide:function(a){
    var c=this.guides.length;
    for(var b=0;b<c;b++){
        if(this.guides[b]==a){
            this.guides.splice(b,1)
        }
    }
    },
handleGuideOver:function(d){
...
destroy:function(){
    AmCharts.removeSet(this.set);
    if(this.axisLine){
        AmCharts.removeSet(this.axisLine.set)
    }
}
});
AmCharts.ValueAxis=AmCharts.Class({
    ...
    updateData:function(){
        ...
        if(this.chart.chartType!="xy"){
            this.stackGraphs("smoothedLine");
            this.stackGraphs("line");
            this.stackGraphs("column");
            this.stackGraphs("step")
        }
        if(this.recalculateToPercents){
            this.recalculate()
        }
        if(this.synchronizationMultiplyer&&this.synchronizeWithAxis){
            this.foundGraphs=true
        }else{
            this.foundGraphs=false;
            this.getMinMax()
            }
        },
draw:function(){
    ...
    if(this.logarithmic){
        var N=this.getMin(0,this.data.length-1);
        if(N<=0||this.minimum<=0){
            var m="logarithmicAxisFailed";
            this.fire(m,{
                type:m
            });
            return
...
var e=this.chart.dy;
var I=false;
if(!isNaN(this.min)&&!isNaN(this.max)&&this.foundGraphs&&this.min!=Infinity&&this.max!=-Infinity){
    var B=this.labelFrequency;
    var x=this.showFirstLabel;
    var A=this.showLastLabel;
    var b=1;
    var F=0;
    var Q=Math.round((this.max-this.min)/this.step)+1;
    if(this.logarithmic==true){
        var h=Math.log(this.max)*Math.LOG10E-Math.log(this.minReal)*Math.LOG10E;
        this.stepWidth=this.axisWidth/h;
        if(h>2){
            Q=Math.ceil((Math.log(this.max)*Math.LOG10E))+1;
            F=Math.round((Math.log(this.minReal)*Math.LOG10E));
            if(Q>this.gridCount){
                b=Math.ceil(Q/this.gridCount)
            }
        }
    }else{
...
if(this.guides.length>0){
    ...
    for(L=0;
        ...
        var z=NaN;
        if(!isNaN(T.toValue)){
            z=this.getCoordinate(T.toValue);
            var a=new this.axisItemRenderer(this,z,"",true,NaN,NaN,T);
            this.set.push(a.graphics())
        }
        var R=NaN;
        if(!isNaN(T.value)){
            R=this.getCoordinate(T.value);
            var U=(z-R)/2;
            var a=new this.axisItemRenderer(this,R,T.label,true,NaN,U,T);
            this.set.push(a.graphics())
        }
        if(!isNaN(z-R)){
            var y=new this.guideFillRenderer(this,z-R,R,T);
            var K=y.graphics();
            this.set.push(K);
            T.graphics=K;
            K.index=L;
            ...
            if(T.balloonText){
                K.mouseover(function(){
                    l.handleGuideOver(this.index)
                });
                K.mouseout(function(){
                    l.handleGuideOut(this.index)
                })
                }
            }
    }
...
for(L=F;L<Q;L+=b){
    var C=AmCharts.roundTo(this.step*L+this.min,J);
    if(String(C).indexOf("e")!=-1){
        v=true;
...
for(L=F;L<Q;L+=b){
    var G=this.step*L+this.min;
    G=AmCharts.roundTo(G,this.maxDecCount+1);
    if(this.integersOnly&&Math.round(G)!=G){}else{
        if(this.logarithmic==true){
            if(G==0){
                G=this.minReal
            }
    ...
    if(!v){
        if(this.logarithmic){
            var k=String(G).split(".");
            if(k[1]){
                j.precision=k[1].length
            }else{
                j.precision=-1
                }
            }
        if(this.usePrefixes){
        q=AmCharts.addPrefix(G,this.chart.prefixesOfBigNumbers,this.chart.prefixesOfSmallNumbers,j)
    }else{
        q=AmCharts.formatNumber(G,j,j.precision)
    }
}else{
    if(String(G).indexOf("e")==-1){
        q=G.toExponential(15)
    }else{
        q=String(G)
        }
        var f=q.split("e");
...
if(this.duration){
    q=AmCharts.formatDuration(G,this.duration,"",this.durationUnits,this.maxInterval,j)
}
if(this.recalculateToPercents){
    q=q+"%"
}else{
...
this.set.push(a.graphics());
if(G==this.baseValue&&this.chart.chartType!="radar"){
    var D;
    var n;
    var M=this.visibleAxisWidth;
    var O=this.visibleAxisHeight;
    if(this.orientation=="horizontal"){
        if(s>=this.x&&s<=this.x+M+1){
            D=[s,s,s+g];
            n=[0+O,0,e]
            }
        }else{
    if(s>=this.y&&s<=this.y+O+1){
        D=[0,M,M+g];
        n=[s,s,s+e]
        }
    }
if(D){
    this.grid0=AmCharts.line(this.chart.container,D,n,this.gridColor,this.gridAlpha*2,1,0);
...
if(this.min>this.baseValue&&this.max>this.baseValue){
    u=this.min
}
if(this.min<this.baseValue&&this.max<this.baseValue){
    u=this.max
...
this.axisCreated=true
    ...
    if(this.chart.chartType!="radar"){
    if(this.rotate){
        this.set.translate(0+","+this.chart.marginTopReal)
    }else{
        this.set.translate(this.chart.marginLeftReal+","+0)
    }
}else{
    this.axisLine.set.toFront()
}
if(!this.visible||I){
    this.set.hide();
...
stackGraphs:function(l){
    var g=[];
    var b=[];
    var o=[];
    var h=[];
    var m;
    var k=this.chart.graphs;
    var e;
    var a;
    var n;
    var p;
    var d;
    var f;
    if((l=="line"||l=="step"||l=="smoothedLine")&&(this.stackType=="regular"||this.stackType=="100%")){
        for(d=0;
            d<k.length;d++){
            n=k[d];
            if(!n.hidden){
                a=n.type;
                if(n.chart==this.chart&&n.valueAxis==this&&l==a&&n.stackable){
                    if(e){
                        n.stackGraph=e;
                        e=n
                        }else{
...
for(f=this.start;
    ...
    for(d=0;
        ...
        if(!n.hidden){
            a=n.type;
            if(n.chart==this.chart&&n.valueAxis==this&&l==a&&n.stackable){
                p=this.data[f].axes[this.id].graphs[n.id];
                m=p.values.value;
                if(!isNaN(m)){
                    if(isNaN(h[f])){
                        h[f]=Math.abs(m)
                    ...
                    if(this.stackType=="regular"){
                        if(l=="line"||l=="step"||l=="smoothedLine"){
                            if(isNaN(g[f])){
                                g[f]=m;
                                p.values.close=m
                                }else{
            ...
            if(n.chart==this.chart&&n.valueAxis==this&&l==a&&n.stackable){
                ...
                if(!isNaN(m)){
                    ...
                    if(this.stackType=="100%"){
                        ...
                        if(c<0){
                            p.values.close=c+b[f];
                            p.values.open=b[f];
                            b[f]=p.values.close
                        }else{
                            p.values.close=c+o[f];
                            p.values.open=o[f];
                            o[f]=p.values.close
                        }
                    }
...
recalculate:function(){
    var d=this.chart.graphs.length;
    for(var g=0;g<d;g++){
        var q=this.chart.graphs[g];
        if(q.valueAxis==this){
            var p="value";
            if(q.type=="candlestick"||q.type=="ohlc"){
                p="open"
            }
            var a;
            var r;
            var f=AmCharts.fitToBounds(this.end+1,0,this.data.length-1);
            var b=this.start;
            if(b>0){
                b--
            }
            for(var o=this.start;
                o<=f;o++){
                r=this.data[o].axes[this.id].graphs[q.id];
                a=r.values[p];
                if(!isNaN(a)){
                    break
                }
            ...
            for(var h=b;h<=f;h++){
            r=this.data[h].axes[this.id].graphs[q.id];
            r.percents={};
...
getMinMax:function(){
    ...
    for(var n=0;n<this.chart.graphs.length;
        n++){
        var b=this.chart.graphs[n].type;
        if(b=="line"||b=="step"||b=="smoothedLine"){
            if(this.expandMinMax){
                a=true
            }
        }
    }
...
if(this.chart.chartType=="serial"){
    if(this.chart.categoryAxis.parseDates==true&&!a){
        if(this.end<this.data.length-1){
            this.end++
        }
    }
...
if(this.includeGuidesInMinMax&&m>0){
    for(var l=0;
        l<m;l++){
        var t=this.guides[l];
        if(t.toValue<this.min){
            this.min=t.toValue
        }
        if(t.value<this.min){
            this.min=t.value
        }
        if(t.toValue>this.max){
            this.max=t.toValue
        }
        if(t.value>this.max){
            this.max=t.value
...
if(!isNaN(this.minTemp)){
    this.min=this.minTemp
}
if(!isNaN(this.maxTemp)){
...
var c;
if(r==0){
    c=Math.pow(10,Math.floor(Math.log(Math.abs(this.max))*Math.LOG10E))/10
}else{
    c=Math.pow(10,Math.floor(Math.log(Math.abs(r))*Math.LOG10E))/10
}
if(isNaN(this.maximum)&&isNaN(this.maxTemp)){
    this.max=Math.ceil(this.max/c)*c+c
}
if(isNaN(this.minimum)&&isNaN(this.minTemp)){
    this.min=Math.floor(this.min/c)*c-c
}
if(this.min<0&&f>=0){
    this.min=0
}
...
if(k<1){
    this.maxDecCount=Math.abs(Math.log(Math.abs(k))*Math.LOG10E);
...
if(this.minReal>1&&this.max-this.minReal>1){
...
if(this.min==0&&this.minReal>1){
    this.minReal=1
}
if(this.min>0&&this.minReal-this.step>0){
    if(this.min+this.step<this.minReal){
        this.minReal=this.min+this.step
    }else{
        this.minReal=this.min
    }
}
var j=Math.log(h)*Math.LOG10E-Math.log(f)*Math.LOG10E;
if(this.logarithmic&&j>2){
    this.min=Math.pow(10,Math.floor(Math.log(Math.abs(f))*Math.LOG10E));
    this.minReal=this.min;
    this.max=Math.pow(10,Math.ceil(Math.log(Math.abs(h))*Math.LOG10E))
}
},
generateNumber:function(a,c){
    var d="";
    var e;
    if(c<1){
        e=Math.abs(c)-1
        ...
        if(c<1){
        return Number("0."+d+String(a))
    }else{
        return Number(String(a)+d)
    }
},
getMin:function(a,d){
    var e;
    for(var g=a;g<=d;g++){
        var h=this.data[g].axes[this.id].graphs;
        for(var f in h){
            var m=this.chart.getGraphById(f);
            if(m.includeInMinMax){
                if(!m.hidden||this.includeHidden){
                    if(isNaN(e)){
                        e=Infinity
                    }
                    this.foundGraphs=true;
                    ...
                    var b;
                    if(this.minMaxField){
                        b=l[this.minMaxField];
                        if(b<e){
                            e=b
                            }
                        }else{
                    for(var c in l){
                        if(c!="percents"&&c!="total"){
                            b=l[c];
                            if(b<e){
                                e=b
                                }
...
getMax:function(){
    ...
    for(var f=this.start;
        f<=this.end;f++){
        var d=this.data[f].axes[this.id].graphs;
        for(var e in d){
            var g=this.chart.getGraphById(e);
            if(g.includeInMinMax){
                if(!g.hidden||this.includeHidden){
                    if(isNaN(a)){
                        a=-Infinity
                    }
                    this.foundGraphs=true;
                    ...
                    var h;
                    if(this.minMaxField){
                        h=c[this.minMaxField];
                        if(h>a){
                            a=h
                            }
                        }else{
                    for(var b in c){
                        if(b!="percents"&&b!="total"){
                            h=c[b];
                            if(h>a){
                                a=h
                                }
...
dispatchZoomEvent:function(b,a){
    var c=new ValueAxisEvent(ValueAxisEvent.AXIS_ZOOMED);
    c.startValue=b;
    c.endValue=a;
    dispatchEvent(c)
    },
zoomToValues:function(b,a){},
coordinateToValue:function(c){
    if(isNaN(c)){
        return NaN
    }
    var a;
    if(this.logarithmic==true){
        ...
        if(this.chart.rotate){
            if(this.reversed==true){
                b=(this.axisWidth-c)/this.stepWidth
            }else{
                b=c/this.stepWidth
            }
        }else{
    ...
    if(this.reversed==true){
        if(this.chart.rotate){
            a=this.min-(c-this.axisWidth)/this.stepWidth
        }else{
            a=c/this.stepWidth+this.min
        }
    }else{
    if(this.chart.rotate){
        a=c/this.stepWidth+this.min
...
getCoordinate:function(a){
    ...
    var c;
    if(this.logarithmic==true){
        var b=(Math.log(a)*Math.LOG10E)-Math.log(this.minReal)*Math.LOG10E;
        if(this.chart.rotate){
            if(this.reversed==true){
                c=this.axisWidth-this.stepWidth*b
            }else{
                c=this.stepWidth*b
            }
        }else{
    ...
    if(this.reversed==true){
        if(this.chart.rotate){
            c=this.axisWidth-this.stepWidth*(a-this.min)
        }else{
            c=this.stepWidth*(a-this.min)
        }
    }else{
    if(this.chart.rotate){
        c=this.stepWidth*(a-this.min)
...
handleSynchronization:function(d){
    var e=this.synchronizeWithAxis.min;
    var b=this.synchronizeWithAxis.max;
    var c=this.synchronizeWithAxis.step;
    if(this.synchronizationMultiplyer){
        this.min=e*this.synchronizationMultiplyer;
...
AmCharts.CategoryAxis=AmCharts.Class({
    ...
    draw:function(){
        ...
        if(this.data.length>0){
            var s=this.end;
            var C=this.start;
            var I=this.labelFrequency;
            var L=0;
            var l=s-C+1;
            var j=this.gridCount;
            var y=this.showFirstLabel;
            var F=this.showLastLabel;
            var t;
            var n="";
            var o=AmCharts.extractPeriod(this.minPeriod);
            ...
            var B;
            var b;
            var Y=this.data[this.data.length-1].time;
            ...
            if(this.parseDates&&!this.equalSpacing){
                ...
                if(e/2==Math.round(e/2)){
                    ...
                    for(S=C;
                        S<=j;S++){
                        Q=z+u*1.5;
                        Q=AmCharts.resetDateToMin(new Date(Q),E,T).getTime();
                        ...
                        if(this.rotate){
                            ...
                            r=false;
                        if(this.nextPeriod[K]){
                            r=this.checkPeriodChange(this.nextPeriod[K],1,Q,z)
                        }
                        var c=false;
                        if(r){
                            B=this.dateFormatsObject[this.nextPeriod[K]];
                            c=true
                            }else{
                            B=this.dateFormatsObject[K]
                        }
        ...
        if(!this.parseDates){
            ...
            if(j>0){
                ...
                if(b<0){
                    ...
                    var h=0;
                    if(this.gridPosition=="start"){
                        t=t-this.cellWidth/2;
                        h=this.cellWidth/2
                        }
                        if((S==C&&!y)||(S==this.end&&!F)){
                        n=" "
                    }
                    if(Math.round(S/I)!=S/I){
                        n=undefined
                    }
    ...
    if(this.parseDates&&this.equalSpacing){
        ...
        var G=false;
        if(this.end-this.start>this.gridCount){
            G=true
        }
        for(S=b;S<m;S++){
            Q=this.data[S].time;
            if(this.checkPeriodChange(E,T,Q,z)){
                t=this.getCoordinate(S-this.start);
                r=false;
                if(this.nextPeriod[K]){
                    r=this.checkPeriodChange(this.nextPeriod[K],1,Q,z)
                }
                ...
                if(!G){
                    var a=new this.axisItemRenderer(this,t,n,undefined,undefined,undefined,undefined,c);
                    this.set.push(a.graphics())
                }else{
                    G=false
                    }
...
for(S=0;
    ...
    if(v){
        ...
        N=this.getCoordinate(S-L)
    }
    v.x[this.id]=N
    }
}
}
var P=this.guides.length;
for(S=0;S<P;S++){
    var W=this.guides[S];
    var D=NaN;
    var U=NaN;
    var X=NaN;
    if(W.toCategory){
        var x=this.chart.getCategoryIndexByValue(W.toCategory);
        if(!isNaN(x)){
            D=this.getCoordinate(x-L);
            var a=new this.axisItemRenderer(this,D,"",true,NaN,NaN,W);
            this.set.push(a.graphics())
        }
    }
    if(W.category){
    var V=this.chart.getCategoryIndexByValue(W.category);
    if(!isNaN(V)){
        U=this.getCoordinate(V-L);
        X=(D-U)/2;
        var a=new this.axisItemRenderer(this,U,W.label,true,NaN,X,W)
    }
}
if(W.toDate){
    if(this.equalSpacing){
        var x=this.chart.getClosestIndex(this.data,"time",W.toDate.getTime(),false,0,this.data.length-1);
        if(!isNaN(x)){
            D=this.getCoordinate(x-L)
        }
    }else{
    D=(W.toDate.getTime()-this.startTime)*this.stepWidth;
    if(this.rotate){
        D+=this.y
    }else{
        D+=this.x
...
if(W.date){
    if(this.equalSpacing){
        var V=this.chart.getClosestIndex(this.data,"time",W.date.getTime(),false,0,this.data.length-1);
        if(!isNaN(V)){
            U=this.getCoordinate(V-L)
        }
    }else{
    U=(W.date.getTime()-this.startTime)*this.stepWidth;
    if(this.rotate){
        U+=this.y
    }else{
        U+=this.x
...
X=(D-U)/2;
if(this.orientation=="horizontal"){
    var a=new this.axisItemRenderer(this,U,W.label,false,X*2,NaN,W)
}else{
    var a=new this.axisItemRenderer(this,U,W.label,false,NaN,X,W)
}
}
this.set.push(a.graphics());
...
this.axisCreated=true;
if(this.rotate){
    this.set.translate(this.x+","+0)
}else{
    this.set.translate(0+","+this.y)
}
if(this.axisLine.set){
    this.axisLine.set.toFront()
}
},
choosePeriod:function(b){
    var a=AmCharts.getPeriodDuration(this.periods[b].period,this.periods[b].count);
    var c=Math.ceil(this.timeDifference/a);
    if(c<=this.gridCount){
        return this.periods[b]
    }else{
        if(b+1<this.periods.length){
            return this.choosePeriod(b+1)
        }else{
            return this.periods[b]
        }
    }
...
checkPeriodChange:function(h,d,f,b){
    var a=new Date(f);
    var g=new Date(b);
    var e=AmCharts.resetDateToMin(a,h,d).getTime();
...
xToIndex:function(a){
    if(this.chart.rotate){
        ...
        var b;
    if(this.parseDates&&!this.equalSpacing){
        var d=this.startTime+Math.round(a/this.stepWidth)-this.minDuration()/2;
    ...
    var c;
    if(this.data[b]){
        c=this.data[b].x[this.id]
    }
    if(this.chart.rotate){
        if(c>this.height+1+this.y){
            b--
        }
        if(c<this.y){
            b++
...
dateToCoordinate:function(b){
    if(this.parseDates&&!this.equalSpacing){
        return(b.getTime()-this.startTime)*this.stepWidth
    }else{
        if(this.parseDates&&this.equalSpacing){
            var a=this.chart.getClosestIndex(this.data,"time",b.getTime(),false,0,this.data.length-1);
...
categoryToCoordinate:function(b){
    if(this.chart){
        var a=this.chart.getCategoryIndexByValue(b);
...
coordinateToDate:function(a){
    return new Date(this.startTime+a/this.stepWidth)
}
});
AmCharts.RectangularAxisRenderer=AmCharts.Class({
    construct:function(d){
        ...
        var n;
        var k;
        this.set=g.container.set();
        var u;
        if(d.orientation=="horizontal"){
            u=AmCharts.line(g.container,[0,p],[0,0],j,q,s);
        ...
        this.axisWidth=d.height;
        if(d.position=="right"){
            u=AmCharts.line(g.container,[0,0,-v],[0,f,f-r],j,q,s);
            k=h+r;
            n=s/2+b+v+p+m-1
        }else{
            u=AmCharts.line(g.container,[0,0],[0,f],j,q,s);
            k=h;
            n=-s/2-b+m
            }
        }
...
AmCharts.RectangularAxisItemRenderer=AmCharts.Class({
    construct:function(A,t,R,I,p,ah,ad,c,y){
        if(R==undefined){
            R=""
        }
        if(!y){
        ...
        if(ad){
            U=true;
            if(!isNaN(ad.tickLength)){
                J=ad.tickLength
            }
            if(ad.lineColor!=undefined){
                ab=ad.lineColor
            }
            if(!isNaN(ad.lineAlpha)){
                r=ad.lineAlpha
            }
            if(!isNaN(ad.dashLength)){
                l=ad.dashLength
            }
            if(!isNaN(ad.lineThickness)){
                aa=ad.lineThickness
            }
            if(ad.inside==true){
                j=true
...
var ag=(n+f)+","+(m+e)+","+o+","+x;
    ...
    if(U){
        ...
        if(B=="horizontal"){
        if(t>=n&&t<=o+1+n){
            b=AmCharts.line(H,[t+y,t+y],[0,J],G,Z,aa);
            this.set.push(b);
            if(t+y>o+n){
                b.hide()
            }
...
if(af){
    ...
    if(t>=m&&t<=x+1+m){
        b=AmCharts.line(H,[0,J],[t+y,t+y],G,Z,aa);
        this.set.push(b);
        if(t+y>x+m){
            b.hide()
        }
        ...
        T="end";
    if((j==true&&O=="left")||(j==false&&O=="right")){
        T="start"
    }
    C=t-F/2;
    if(d==1&&s>0&&!ad){
...
AmCharts.RectangularAxisGuideFillRenderer=AmCharts.Class({
    construct:function(g,k,j,f){
        ...
        var h=(g.visibleAxisX+m)+","+(g.visibleAxisY+l)+","+g.visibleAxisWidth+","+g.visibleAxisHeight;
    if(d=="vertical"){
        this.fill=AmCharts.rect(a,g.width,k,b,c);
        this.fill.translate(m+","+(j-e+l))
    }else{
        this.fill=AmCharts.rect(a,k,g.height,b,c);
            ...
            for(var z=0;z<f;z++){
                ...
                if(C){
                    ...
                    if(A==0){
                        ...
                        var H=AmCharts.text(p.container,j+5,g,G[z].category,{
                        fill:u,
                        "text-anchor":v,
                        "font-family":B,
                        "font-size":q
...
AmCharts.RadarAxisItemRenderer=AmCharts.Class({
    construct:function(p,n,I,A,j,Y,V){
        if(I==undefined){
            I=""
        }
        ...
        if(V){
            N=true;
            if(!isNaN(V.tickLength)){
                B=V.tickLength
            }
            if(V.lineColor!=undefined){
                U=V.lineColor
            }
            if(!isNaN(V.lineAlpha)){
                k=V.lineAlpha
            }
            if(!isNaN(V.dashLength)){
                g=V.dashLength
            }
            if(!isNaN(V.lineThickness)){
                T=V.lineThickness
            }
            if(V.inside==true){
                f=true
...
if(f){
    ...
    if(N){
    var X=AmCharts.text(z,F+(B+3)*S,n,I,{
        fill:s,
        "text-anchor":M,
        "font-family":a,
        "font-size":t
    ...
    this.set.push(X);
    var b=AmCharts.line(z,[F,F+B*S],[n,n],v,R,T);
    this.set.push(b)
    }
    var J=p.y-n;
if(c=="polygons"){
    ...
    H=AmCharts.circle(z,J,0,0,T,U,k)
}
this.set.push(H);
    H.translate(F+","+E);
    if(d==1&&l>0&&!V){
        var Q=p.previousCoord;
        var m;
        if(c=="polygons"){
            for(P=K;
                P>=0;P--){
            ...
            m=AmCharts.wedge(z,0,0,0,-360,J,J,Q,0,{
                fill:W,
                "fill-opacity":l,
                stroke:0,
                "stroke-opacity":0,
...
AmCharts.RadarAxisGuideFillRenderer=AmCharts.Class({
    construct:function(g,p,o,f){
        ...
        if(isNaN(e)){
            ...
            var n=l-Math.abs(p);
            this.fill=AmCharts.wedge(c,0,0,h,(b-h),l,l,n,0,{
                fill:d,
                "fill-opacity":e,
                stroke:0,
                "stroke-opacity":0,
...
AmCharts.AmGraph=AmCharts.Class({
    ...
    draw:function(){
        ...
        if(this.data){
            if(this.data.length>0&&this.valueAxis.axisCreated){
                this.columnsArray=[];
                if(!this.hidden){
                    this.createGraph()
                }
...
createGraph:function(){
    ...
    if(!this.fillColors){
        this.fillColors=[this.lineColor]
    }
    if(this.fillAlphas==undefined){
        this.fillAlphas=0
    }
    if(this.bulletColor==undefined){
        this.bulletColor=this.lineColor;
        this.bulletColorNegative=this.negativeLineColor
    }
    if(this.bulletAlpha==undefined){
        this.bulletAlpha=this.lineAlpha
    }
    if(!this.bulletBorderColor){
...
createRadarGraph:function(){
    var m=this.valueAxis.stackType;
    var a=[];
    var p=[];
    var e;
    var d;
    for(var k=this.start;
        k<=this.end;k++){
        var n=this.data[k];
        ...
        if(isNaN(s)){
            ...
            var l=this.y-(this.valueAxis.getCoordinate(s)-this.height);
            var f=180-360/(this.end-this.start+1)*k;
            var b=(l*Math.sin((f)/(180)*Math.PI));
            var r=(l*Math.cos((f)/(180)*Math.PI));
            a.push(b);
            p.push(r);
            var h=this.createBullet(t,b,r,k);
            if(!h){
                h=0
                }
                if(this.labelText){
                var q=this.createLabel(t,b,r);
...
if(c){
    for(var g=0;g<c.length;
        g++){
        this.addHoverListeners(c[g])
    }
    }
},
positionLabel:function(c,f,b){
    var a=0;
    var e=0;
    var d=c.getBBox();
    switch(f){
...
createSerialGraph:function(){
    if(typeof(this.fillAlphas)=="object"){
        this.fillAlphas=this.fillAlphas[0]
    }
    if(typeof(this.negativefillAlphas)=="object"){
        this.negativefillAlphas=this.negativefillAlphas[0]
    }
    var at=this;
    var Z=this.columnWidth;
    var d=this.valueAxis.getCoordinate(this.valueAxis.min);
    if(this.valueAxis.logarithmic){
        d=this.valueAxis.getCoordinate(this.valueAxis.minReal)
    }
    this.minCoord=d;
    this.pmh=this.height+1;
    ...
    if(!this.scrollbar&&(this.type=="line"||this.type=="smoothedLine"||this.type=="step")){
        if(this.data.length==1&&this.type!="step"&&this.bullet=="none"){
            this.bullet="round";
            this.resetBullet=true
        }
        if(this.negativeFillColors||this.negativeLineColor!=undefined){
            var ap=this.negativeBase;
            if(ap>this.valueAxis.max){
                ap=this.valueAxis.max
            }
            if(ap<this.valueAxis.min){
                ap=this.valueAxis.min
            }
            if(this.valueAxis.logarithmic){
                ap=this.valueAxis.minReal
            }
            var g=this.valueAxis.getCoordinate(ap);
            var a=this.valueAxis.getCoordinate(this.valueAxis.max);
            if(this.rotate){
                this.pmh=this.height;
                this.pmw=Math.abs(a-g);
                this.nmh=this.height;
                this.nmw=Math.abs(d-g);
                this.nmx=this.y;
                this.nmy=this.y;
                if(this.valueAxis.reversed){
                    this.pmx=this.x;
                    this.nmx=g
                    }else{
                    this.pmx=g;
...
if(aj>J){
    ...
    if(this.type=="column"){
    Z=(aL*Z-(aj*(this.columnCount-1)))/this.columnCount
}else{
    Z=aL*Z
    }
    if(Z<1){
...
var G;
var R;
if(this.type=="line"||this.type=="step"||this.type=="smoothedLine"){
    if(this.start>0){
        for(R=this.start-1;
            R>-1;R--){
            Y=this.data[R];
...
for(R=this.start;R<=this.end;
    ...
    var S=NaN;
    var aB=undefined;
    var e=this.fillColors;
    if(ah.color!=undefined){
        e=[ah.color]
    }
    if(ah.fillColors){
        e=ah.fillColors
    ...
    var ao;
    var y=ah.values;
    if(this.valueAxis.recalculateToPercents){
        y=ah.percents
    }
    if(!this.stackable||an=="none"||an=="3d"){
        S=y.value
    }else{
        S=y.close
        }
        if(this.type=="candlestick"||this.type=="ohlc"){
        S=y.close;
        var aK=y.low;
        m=this.valueAxis.getCoordinate(aK);
        var o=y.high;
        T=this.valueAxis.getCoordinate(o)
    }
    var M=y.open;
    K=this.valueAxis.getCoordinate(S);
    if(!isNaN(M)){
        aq=this.valueAxis.getCoordinate(M)
    }
    if(!this.scrollbar){
        if(this.showBalloonAt=="close"){
            ah.y=K
        }
        if(this.showBalloonAt=="open"){
            ah.y=aq
        }
        if(this.showBalloonAt=="high"){
            ah.y=T
        }
        if(this.showBalloonAt=="low"){
            ah.y=m
        }
    }
...
case"column":
    ...
    if(!isNaN(S)){
        ...
        if(S<this.negativeBase){
            ah.isNegative=true;
            if(this.negativeFillColors){
                ac=this.negativeFillColors
            }
            if(this.negativeLineColor!=undefined){
                b=this.negativeLineColor
            }
        }
        var aG=this.valueAxis.min;
    var s=this.valueAxis.max;
    if((S<aG&&(M<aG||M==undefined))||(S>s&&M>s)){}else{
        if(this.rotate){
            if(an=="3d"){
                var A=K-0.5*(Z+aj)+aj/2+l*this.columnIndex;
                var B=aI+n*this.columnIndex
            }else{
                var A=K-(this.columnCount/2-this.columnIndex)*(Z+aj)+aj/2;
                var B=aI
                }
                var C=Z;
            aJ=x;
            ...
            H=H+(au-B);
            H=AmCharts.fitToBounds(H,this.x-B,this.x+this.width-B);
            if(A<this.y+this.height&&C>0){
                aB=new AmCharts.Cuboid(this.container,H,C,n,l,ac,L,this.lineThickness,b,this.lineAlpha,q,ar);
                aB.y(A);
                aB.x(B);
                if(I!="bottom"){
                    I="right";
    ...
    I="top";
    if(an=="3d"){
        var B=x-0.5*(Z+aj)+aj/2+n*this.columnIndex;
        var A=aq+l*this.columnIndex
    }else{
        var B=x-(this.columnCount/2-this.columnIndex)*(Z+aj)+aj/2;
        var A=aq
        }
        var C=Z;
    aJ=B+Z/2;
    ...
    al=B+Z/2;
    ak=K;
    if(B+C>this.x+this.width+this.columnIndex*n){
        C=this.x+this.width-B+this.columnIndex*n
    }
    if(B<this.x){
        C-=this.x-B;
        B=this.x
    ...
    H=H+(ad-A);
    H=AmCharts.fitToBounds(H,this.y-A,this.y+this.height-A);
    if(B<this.x+this.width+this.columnIndex*n&&C>0){
        aB=new AmCharts.Cuboid(this.container,C,H,n,l,ac,L,this.lineThickness,b,this.lineAlpha,q,ar);
        aB.y(A);
        aB.x(B);
        if(S<0){
            I="bottom"
...
if(aB){
    if(!this.scrollbar){
        if(an=="none"){
            if(this.rotate){
                aC=(this.end+1-R)*ae-this.index
            }else{
                aC=ae*R+this.index
            }
        }
        if(an=="3d"){
        aC=(ae-this.index)*(R+1);
        if(this.rotate){
            aH=A+Z/2;
            aH+=l*this.columnIndex
        }else{
            aJ+=n*this.columnIndex;
            aH+=l*this.columnIndex
        }
    }
    if(an=="regular"||an=="100%"){
...
if(this.dx==0&&this.dy==0){
    if(this.sDur>0&&!this.animationPlayed){
        if(this.rotate){
            af=x-aI;
            pFinalDimension=x;
            pInitialDimension=aI
        }else{
            af=K-aq;
            pFinalDimension=K;
            pInitialDimension=aq
            }
            if(this.seqAn){
            aB.set.hide();
            ...
            this.animate(aB.set,af,pInitialDimension,pFinalDimension)
        }
    }
}
var aM=aB.set;
...
break;
case"candlestick":
    if(!isNaN(M)&&!isNaN(o)&&!isNaN(aK)&&!isNaN(S)){
    var W;
    var az;
    ac=e;
    b=this.lineColor;
    ...
    if(S<M){
        ...
        if(this.negativeFillAlphas){
            ab=this.negativeFillAlphas
        }
        if(this.negativeLineColor!=undefined){
            b=this.negativeLineColor
        }
    ...
    if(A<this.y){
        ...
        if(S>M){
            ...
            if(K<this.y+this.height&&K>this.y){
            W=AmCharts.line(this.container,N,[K,K],b,this.lineAlpha,this.lineThickness);
            az=AmCharts.line(this.container,ay,[K,K],b,this.lineAlpha,this.lineThickness)
        }
        if(Math.abs(x-aI)<1){
            aB=new AmCharts.line(this.container,[0,0],[0,C],b,this.lineAlpha,1);
            aB.translate(B+","+A)
        }else{
            aB=new AmCharts.Cuboid(this.container,x-aI,C,n,l,ac,L,this.lineThickness,b,this.lineAlpha,q,ar);
            aB.y(A);
            aB.x(B)
            }
        }
    ...
    if(B<this.x){
        ...
        if(B<this.x+this.width&&C>0){
        if(Math.abs(K-aq)<1){
            aB=new AmCharts.line(this.container,[0,C],[0,0],b,this.lineAlpha,1);
            aB.translate(B+","+A)
        }else{
            aB=new AmCharts.Cuboid(this.container,C,K-aq,n,l,ac,ab,this.lineThickness,b,this.lineAlpha,q,ar);
            aB.x(B);
            aB.y(A)
            }
            var aE;
        ...
        if(S>M){
            ...
            W=AmCharts.line(this.container,[x,x],aE,b,this.lineAlpha,this.lineThickness);
...
var t;
if(this.rotate){
    p=AmCharts.line(this.container,[aI,aI],[K-Z/2,K],b,this.lineAlpha,this.lineThickness,this.dashLength);
    ...
    p=AmCharts.line(this.container,[x-Z/2,x],[aq,aq],b,this.lineAlpha,this.lineThickness,this.dashLength);
...
if(!this.scrollbar&&!isNaN(S)){
    if(this.end-this.start<=this.hideBulletsCount||this.hideBulletsCount==0){
        var r=this.createBullet(ah,al,ak,R);
        if(!r){
            r=0
            }
            if(this.labelText){
            var aa=this.createLabel(ah,aJ,aH);
            if(this.type=="column"){
                if(this.rotate){
                    if(I=="right"||I=="bottom"){
                        aa.attr({
    ...
    switch(I){
        ...
        case"right":
            ...
            break;
        case"bottom":
            if(this.rotate&&this.type=="column"){
            if(S<0){
                F=aI-c/2-7
            }else{
                F=aI+6+c/2
...
aa.translate(ax+","+av);
aw=aa.getBBox();
if(aw.x<this.x||aw.y<this.y||aw.x+aw.width>this.x+this.width||aw.y+aw.height>this.y+this.height){
    aa.remove()
}
}
}
...
createLabel:function(c,d,b){
    var h=this.numberFormatter;
    if(!h){
        h=this.chart.numberFormatter
    }
    var a=this.color;
    if(a==undefined){
        a=this.chart.color
    ...
    var f=this.fontSize;
    if(f==undefined){
        f=this.chart.fontSize
    }
    var g=this.chart.formatString(this.labelText,c);
    var e=AmCharts.text(this.container,d,b,g,{
        fill:a,
        "font-family":this.chart.fontFamily,
        "font-size":f
    });
...
drawLineGraph:function(a,e){
    if(a.length>1){
        var k=AmCharts.line(this.container,a,e,this.lineColor,this.lineAlpha,this.lineThickness,this.dashLength);
        this.positiveObjectsToClip.push(k);
        this.set.push(k);
        if(this.negativeLineColor!=undefined){
            var d=AmCharts.line(this.container,a,e,this.negativeLineColor,this.lineAlpha,this.lineThickness,this.dashLength);
        ...
        this.set.push(j);
        this.positiveObjectsToClip.push(j);
        if(this.negativeFillColors||this.negativeLineColor!=undefined){
            var g=this.fillAlphas;
            if(this.negativeFillAlphas){
                g=this.negativeFillAlphas
            }
            var f=this.negativeLineColor;
            if(this.negativeFillColors){
                f=this.negativeFillColors
            }
            var c=AmCharts.polygon(this.container,b,h,f,g);
            this.set.push(c);
            this.negativeObjectsToClip.push(c)
        }
    }
}
},
drawSmoothedGraph:function(a,d){
    if(a.length>1){
        var j=new AmCharts.Bezier(this.container,a,d,this.lineColor,this.lineAlpha,this.lineThickness,NaN,NaN,this.dashLength);
        this.positiveObjectsToClip.push(j.path);
        this.set.push(j.path);
        if(this.negativeLineColor!=undefined){
            var c=new AmCharts.Bezier(this.container,a,d,this.negativeLineColor,this.lineAlpha,this.lineThickness,NaN,NaN,this.dashLength);
            this.set.push(c.path);
            this.negativeObjectsToClip.push(c.path)
        }
        if(this.fillAlphas>0){
            var e=[];
            if(this.rotate){
                e.push("L",this.baseCoord,d[d.length-1]);
                e.push("L",this.baseCoord,d[0]);
                e.push("L",a[0],d[0])
            }else{
                e.push("L",a[a.length-1],this.baseCoord);
...
launchAnimation:function(){
    if(this.sDur>0&&!this.animationPlayed){
        this.set.attr({
            opacity:this.startAlpha
            });
        if(this.rotate){
            this.set.translate((-1000)+","+0)
        }else{
            this.set.translate(0+","+(-1000))
        }
        if(this.seqAn){
            var b=this;
...
animate:function(d,a,e,b){
    var c=this.animationArray;
    if(!d&&c.length>0){
        d=c[0].obj;
        a=c[0].fh;
        e=c[0].ip;
...
createBullet:function(q,p,o,f){
    ...
    if(!isNaN(q.bulletSize)){
        b=q.bulletSize
    }
    if(!isNaN(this.maxValue)){
        var n=q.values.value;
        if(!isNaN(n)){
            b=n/this.maxValue*this.maxBulletSize
        }
    }
    var r;
if(this.bullet=="none"&&!q.bullet){}else{
    var g=this.bulletColor;
    if(q.isNegative&&this.bulletColorNegative!=undefined){
        g=this.bulletColorNegative
    }
    ...
    var d=g;
    var e=this.bulletAlpha;
    switch(m){
        case"round":
            r=AmCharts.circle(this.container,b/2,d,e,c,h,k);
            break;
        case"square":
            r=AmCharts.rect(this.container,b,b,d,e,c,h,k);
            r.translate(-b/2+","+(-b/2));
            break;
        case"triangleUp":
            r=AmCharts.triangle(this.container,b,0,d,e,c,h,k);
            break;
        case"triangleDown":
            r=AmCharts.triangle(this.container,b,180,d,e,c,h,k);
            break;
        case"triangleLeft":
            r=AmCharts.triangle(this.container,b,270,d,e,c,h,k);
            break;
        case"triangleRight":
            r=AmCharts.triangle(this.container,b,90,d,e,c,h,k);
            break;
        case"bubble":
            r=AmCharts.circle(this.container,b/2,d,e,c,h,k,true);
            break
            }
            if(r){
        r.translate(p+","+o)
...
if(this.customBullet||q.customBullet){
    var a=this.customBullet;
    if(q.customBullet){
        a=q.customBullet
    }
    if(a){
        ...
        r=this.container.image(a,p,o,b,b).attr({
            preserveAspectRatio:true
        });
        if(this.centerCustomBullets){
            r.translate(-b/2+","+(-b/2))
        }
    }
}
if(r){
    ...
    this.set.push(r);
    if(this.chartType=="serial"){
        if(p<this.x||p>this.x+this.width||o<this.y||o>this.y+this.height){
            r.remove();
            r=null
            }
        }
...
handleRollOut:function(c){
    if(c){
        var a="rollOutGraphItem";
        var b={
            type:a,
            item:c,
            index:c.index,
...
handleClick:function(c){
    if(c){
        ...
        this.chart.fire(a,b);
        if(c.url){
            if(this.urlTarget=="_self"||!this.urlTarget){
...
handleDoubleClick:function(c){
    if(c){
        var a="doubleClickGraphItem";
        var b={
            type:a,
            item:c,
            index:c.index,
...
AmCharts.ChartCursor=AmCharts.Class({
    ...
    draw:function(){
        ...
        this.interval=setInterval(function(){
            c.detectMovement.call(c)
        },20);
        var b=this.categoryBalloonColor;
        if(b==undefined){
            b=this.cursorColor
        }
        ...
        if(this.rotate){
            this.categoryBalloon.pointerOrientation="horizontal"
        }
        if(this.type=="cursor"){
            this.createCursor()
        }else{
...
updateData:function(){
    ...
    if(this.data){
        if(this.data.length>0){
            if(this.data){
                this.firstTime=this.data[0].time;
...
createCursor:function(){
    ...
    var d;
    if(this.rotate){
        c=[0,this.width,this.width+this.dx];
        d=[0,0,this.dy]
        }else{
        c=[this.dx,0,0];
    ...
    if(this.rotate){
        ...
        if(this.categoryBalloonPosition=="right"){
            if(this.inside){
                this.categoryBalloon.setBounds(this.x,this.y+this.dy,this.x+this.width+this.dx,this.y+this.height+this.dy)
            }else{
                this.categoryBalloon.setBounds(this.x+this.width+this.dx+this.axisThickness,this.y+this.dy,this.x+this.width+1000,this.y+this.height+this.dy)
            }
        }else{
        if(this.inside){
            this.categoryBalloon.setBounds(this.x,this.y,this.width+this.x,this.height+this.y)
        }else{
            this.categoryBalloon.setBounds(-1000,-1000,this.x-b-this.axisThickness,this.y+this.height+15)
        }
    }
}else{
    this.categoryBalloon.maxWidth=this.width;
    if(this.categoryAxis.parseDates){
        b=0;
        this.categoryBalloon.pointerWidth=0
    }
    if(this.categoryBalloonPosition=="top"){
        if(this.inside){
            this.categoryBalloon.setBounds(this.x+this.dx,this.y+this.dy,this.width+this.dx+this.x,this.height+this.y)
        }else{
            this.categoryBalloon.setBounds(this.x+this.dx,-1000,this.width+this.dx+this.x,this.y+this.dy-b-this.axisThickness)
        }
    }else{
    if(this.inside){
        this.categoryBalloon.setBounds(this.x,this.y,this.width+this.x,this.height+this.y-b)
    }else{
        this.categoryBalloon.setBounds(this.x,this.y+this.height+b+this.axisThickness-1,this.x+this.width,this.y+this.height+b+this.axisThickness)
    }
}
}
this.hideCursor()
...
detectMovement:function(){
    if(this.chart.mouseX>this.x&&this.chart.mouseX<this.x+this.width&&this.chart.mouseY>this.y&&this.chart.mouseY<this.height+this.y){
        if(this.pan){
            if(!this.rolledOver){
...
getMousePosition:function(){
    ...
    if(this.rotate){
        ...
        if(a>this.height+this.y){
            a=this.height+this.y
        }
    }else{
    a=this.chart.mouseX;
    if(a<this.x){
...
updateSelectionHeight:function(b){
    if(this.selection){
        this.selection.remove()
    }
    var c;
    var a;
    if(this.selectionPosY>b){
        c=b;
        a=this.selectionPosY-b
    }
    if(this.selectionPosY<b){
        c=this.selectionPosY;
    ...
    if(this.selectionPosY==b){
        ...
        if(a>0){
        this.selection=AmCharts.rect(this.container,this.width,a,[this.cursorColor],[this.selectionAlpha]);
        this.selection.translate(this.x+","+c);
        this.set.push(this.selection)
    }
},
updateSelectionWidth:function(c){
    if(this.selection){
        this.selection.remove()
    }
    var a;
    var b;
    if(this.selectionPosX>c){
        a=c;
        b=this.selectionPosX-c
    }
    if(this.selectionPosX<c){
        a=this.selectionPosX;
    ...
    if(this.selectionPosX==c){
        ...
        if(b>0){
        this.selection=AmCharts.rect(this.container,b,this.height,[this.cursorColor],[this.selectionAlpha]);
        this.selection.translate(a+","+this.y);
        this.set.push(this.selection)
    }
},
arrangeBalloons:function(){
    this.valueBalloons.sort(this.compareY);
    var c=this.valueBalloons.length;
    var a=this.y+this.height;
    for(var b=0;b<c;b++){
        var d=this.valueBalloons[b].balloon;
...
arrangeBalloons2:function(){
    this.valueBalloons.reverse();
    var f=this.valueBalloons.length;
    var a;
    var e;
    for(var d=0;
        d<f;d++){
        var g=this.valueBalloons[d].balloon;
        a=g.bottom;
        var c=g.bottom-g.yPos;
        if(d>0){
            if(a-c<e+3){
                g.setBounds(this.x,e+3,this.x+this.width,e+c+3);
                g.draw()
                }
            }
        if(g.set){
...
showBullets:function(){
    ...
    for(var d=0;d<this.chart.graphs.length;
        d++){
        var g=this.chart.graphs[d];
        if(g.showBalloon&&!g.hidden&&g.balloonText){
            ...
            if(!isNaN(f)){
                ...
                if(this.rotate){
                    ...
                    var a=AmCharts.circle(this.container,this.bulletSize/2,this.chart.getBalloonColor(g,h),g.cursorBulletAlpha);
                a.translate(c+","+j);
...
destroy:function(){
    this.clear();
    if(this.categoryBalloon){
        this.categoryBalloon.destroy()
    }
...
destroyValueBalloons:function(){
    if(this.valueBalloons){
        for(var a=0;
            a<this.valueBalloons.length;
            a++){
            this.valueBalloons[a].balloon.destroy()
        }
        }
    },
zoom:function(e,a,c,b){
    this.destroyValueBalloons();
    this.zooming=false;
    if(this.rotate){
        currentMouse=this.chart.mouseY;
        this.selectionPosY=currentMouse
    }else{
        currentMouse=this.chart.mouseX;
    ...
    this.zoomed=true;
    if(this.categoryAxis.parseDates&&!this.categoryAxis.equalSpacing){
        var d=this.endTime-this.startTime+this.categoryAxis.minDuration();
        if(this.rotate){
            this.stepWidth=this.height/d
        }else{
            this.stepWidth=this.width/d
        }
    }else{
    if(this.rotate){
        this.stepWidth=this.height/(this.end-this.start)
    }else{
        this.stepWidth=this.width/(this.end-this.start)
    }
}
this.setPosition();
this.hideCursor()
...
setPosition:function(a,c){
    ...
    if(this.type=="cursor"){
        if(this.data.length>0){
            ...
            if(a!=this.previousMousePosition||this.zoomed==true){
                if(!isNaN(a)){
                    var b=this.categoryAxis.xToIndex(a);
                    if(b!=this.previousIndex||this.zoomed||this.cursorPosition=="mouse"){
                        this.updateCursor(b,c);
                        this.zoomed=false
                        }
                    }
            }
...
updateCursor:function(f,x){
    ...
    if(this.panning){
        var u;
        if(this.rotate){
            u=this.panClickPos-this.chart.mouseY
        }else{
            u=this.panClickPos-this.chart.mouseX
        }
        ...
        if(p!=0){
            if(this.categoryAxis.parseDates&&!this.categoryAxis.equalSpacing){
                if(this.panClickEndTime+p>this.lastTime){
                    p=this.lastTime-this.panClickEndTime
                }
                if(this.panClickStartTime+p<this.firstTime){
                    p=this.firstTime-this.panClickStartTime
                }
                var a={};
                ...
                if(this.panClickEnd+p>=this.data.length||this.panClickStart+p<0){}else{
                    var a={};
                    a.type="zoomed";
                    a.start=this.panClickStart+p;
    ...
    if(this.cursorPosition=="start"){
        e-=this.categoryAxis.cellWidth/2
    }
    if(this.cursorPosition=="mouse"){
        if(this.rotate){
            e=this.chart.mouseY-2
        }else{
            e=this.chart.mouseX-2
        }
    }
    if(this.rotate){
    if(e<this.y){
    ...
    if(e>this.height+1+this.y){
    if(this.zooming){
        e=this.height+1+this.y
    }else{
        this.hideCursor();
        return
    }
...
if(this.cursorAlpha>0){
    var b=this.line.getBBox();
    if(this.rotate){
        this.line.translate(0+","+Math.round((e-b.y+this.dy)))
    }else{
        this.line.translate(Math.round((e-b.x))+","+0)
    }
    this.line.show()
    }
    if(this.rotate){
    this.linePos=e+this.dy
}else{
    this.linePos=e
    }
    if(this.zooming){
    if(this.rotate){
        this.updateSelectionHeight(e)
    }else{
        this.updateSelectionWidth(e)
    }
}
var g=true;
if(this.chart.touchEventsEnabled&&this.zooming){
    g=false
}
if(this.categoryBalloonEnabled&&g){
    t=this.data[this.index];
    if(this.rotate){
        if(this.inside){
            if(this.categoryBalloonPosition=="right"){
                this.categoryBalloon.setBounds(this.x,this.y+this.dy,this.x+this.width+this.dx,this.x+e+this.dy)
            }else{
                this.categoryBalloon.setBounds(this.x,this.y+this.dy,this.x+this.width+this.dx,this.x+e)
            }
        }
    ...
    if(this.categoryBalloonPosition=="right"){
        if(this.inside){
            this.categoryBalloon.setPosition(this.x+this.width+this.dx,e+this.dy)
        }else{
            this.categoryBalloon.setPosition(this.x+this.width+this.dx+this.axisThickness,e+this.dy)
        }
    }else{
    if(this.inside){
        this.categoryBalloon.setPosition(this.x,e)
    }else{
        this.categoryBalloon.setPosition(this.x-this.axisThickness,e)
    }
}
}else{
    if(this.categoryBalloonPosition=="top"){
        if(this.inside){
            this.categoryBalloon.setPosition(e+this.dx,this.y+this.dy)
        }else{
            this.categoryBalloon.setPosition(e+this.dx,this.y+this.dy-this.axisThickness+1)
        }
    }else{
    if(this.inside){
        this.categoryBalloon.setPosition(e,this.y+this.height)
    }else{
        this.categoryBalloon.setPosition(e,this.y+this.height+this.axisThickness-1)
    }
}
}
if(this.categoryAxis.parseDates){
    var c=AmCharts.formatDate(t.category,this.categoryBalloonDateFormat);
    if(c.indexOf("fff")!=-1){
        c=AmCharts.formatMilliseconds(c,t.category)
    }
    this.categoryBalloon.showBalloon(c)
}else{
    this.categoryBalloon.showBalloon(t.category)
}
}else{
    this.categoryBalloon.hide()
}
if(this.chart.graphs&&this.bulletsEnabled){
    this.showBullets()
}
this.destroyValueBalloons();
if(this.chart.graphs&&this.valueBalloonsEnabled&&g&&this.chart.balloon.enabled){
    this.valueBalloons=[];
    for(var q=0;q<this.chart.graphs.length;
        q++){
        var d=this.chart.graphs[q];
        if(d.showBalloon&&!d.hidden&&d.balloonText){
            ...
            if(!isNaN(n)){
                ...
                if(this.rotate){
                    m=n;
                    s=o;
                    if(s<this.y||s>this.y+this.height){
                        j=false
                    }
                }else{
                m=o;
            ...
            if(j){
            var v=this.chart.getBalloonColor(d,r);
            var h=new AmCharts.AmBalloon();
            h.chart=this.chart;
            this.copyBalloonProperties(h);
            h.setBounds(this.x,this.y,this.x+this.width,this.y+this.height);
            h.pointerOrientation="horizontal";
            h.changeColor(v);
            if(d.balloonAlpha!=undefined){
                h.fillAlpha=d.balloonAlpha
            }
            if(d.balloonTextColor!=undefined){
                h.color=d.balloonTextColor
            }
            h.setPosition(m,s);
            balloonText=this.chart.formatString(d.balloonText,r);
            if(balloonText!=""){
                h.showBalloon(balloonText)
            }
            if(!this.rotate&&h.set){
                h.set.hide()
            }
            this.valueBalloons.push({
                yy:n,
                balloon:h
            })
        }
...
if(x){
    ...
    if(this.rotate){
        a.position=this.chart.mouseY
    }else{
        a.position=this.chart.mouseX
    }
    this.fire(y,a);
    this.chart.fire(y,a);
    this.skipZoomDispatch=false
}else{
    this.skipZoomDispatch=true
}
this.previousIndex=this.index
}
if(!this.chart.mouseIsOver&&!this.zooming&&!this.panning&&!this.chart.touchEventsEnabled){
    this.hideCursor()
}
},
copyBalloonProperties:function(c){
    var d=this.chart.balloon;
        ...
        if(this.zoomable){
            if(this.zooming){
                ...
                if(this.type=="cursor"){
                    ...
                    if(this.rotate){
                        b=this.chart.mouseY;
                        this.selectionPosY=b
                        }else{
                        b=this.chart.mouseX;
                        this.selectionPosX=b
                        }
                        if(Math.abs(b-this.initialMouse)<2&&this.fromIndex==this.index){}else{
                        c={
                            type:"zoomed"
                        };
                        if(this.index<this.fromIndex){
                            c.end=this.fromIndex;
                            c.start=this.index
                            }else{
                            c.end=this.index;
                        ...
                        if(this.categoryAxis.parseDates&&!this.categoryAxis.equalSpacing){
                            c.start=this.data[c.start].time;
                            c.end=this.data[c.end].time
                        }
                        this.allBullets.remove();
                        if(!this.skipZoomDispatch){
                            this.fire("zoomed",c)
                        }
                    }
                }else{
            var a=this.chart.mouseY;
            var d=this.chart.mouseX;
            if(Math.abs(d-this.initialMouseX)<3&&Math.abs(a-this.initialMouseY)<3){}else{
                c={
                    type:"zoomed"
                };
...
handleMouseDown:function(a){
    if(this.zoomable||this.pan){
        if((this.chart.mouseX>this.x&&this.chart.mouseX<this.x+this.width&&this.chart.mouseY>this.y&&this.chart.mouseY<this.height+this.y)||a=="fake"){
            this.setPosition();
            if(this.pan){
                this.zoomable=false;
                this.chart.setMouseCursor("move");
                ...
                if(this.rotate){
                    this.panClickPos=this.chart.mouseY
                }else{
                    this.panClickPos=this.chart.mouseX
                }
            ...
            if(this.zoomable){
                if(this.type=="cursor"){
                    ...
                    if(this.rotate){
                        this.initialMouse=this.chart.mouseY;
                        this.selectionPosY=this.linePos
                    }else{
                        this.initialMouse=this.chart.mouseX;
...
AmCharts.SimpleChartScrollbar=AmCharts.Class({
    ...
    draw:function(){
        if(this.chart.touchEventsEnabled){
            this.updateOnReleaseOnly=true
        }
        var c=this;
        this.destroy();
        this.interval=setInterval(function(){
            c.updateScrollbar.call(c)
        },20);
        this.container=this.chart.container;
        this.set=this.container.set();
        this.data=this.chart.chartData;
        ...
        this.categoryAxis=this.chart.categoryAxis;
        if(this.rotate){
            this.width=this.scrollbarHeight;
        ...
        if(this.height&&this.width){
            var a=AmCharts.rect(this.container,this.width,this.height,[this.backgroundColor],[this.backgroundAlpha]);
            this.set.push(a);
            if(this.chart.touchEventsEnabled){
                a.touchend(function(){
                    c.handleBackgroundClick()
                })
                }
                a.click(function(){
                c.handleBackgroundClick()
            ...
            if(this.chart.touchEventsEnabled){
                this.dragger.touchstart(function(d){
                    c.handleDragStart(d)
                }).touchend(function(){
                    c.handleDragStop()
                })
                }
                this.dragger.mousedown(function(d){
                c.handleDragStart(d)
            }).mouseup(function(){
                c.handleDragStop()
            }).mouseover(function(){
            ...
            var b;
            if(this.rotate){
                b=Math.round(this.width/2-this.dragIconWidth/2);
                ...
                b=Math.round(this.height/2-this.dragIconHeight/2)+AmCharts.ddd;
                this.dragIconLeft.attr("y",b);
                this.dragIconRight.attr("y",b)
            }
            this.iconPosition=b;
            this.dragIconLeft.mousedown(function(){
                c.handleLeftIconDragStart()
            }).mouseup(function(){
                c.handleLeftIconDragStop()
            }).mouseover(function(){
                c.handleIconRollOver()
            }).mouseout(function(){
                c.handleIconRollOut()
            });
            this.dragIconRight.mousedown(function(){
                c.handleRightIconDragStart()
            }).mouseup(function(){
                c.handleRightIconDragStop()
            }).mouseover(function(){
                c.handleIconRollOver()
            }).mouseout(function(){
                c.handleIconRollOut()
...
updateScrollbarSize:function(b,a){
    if(this.rotate){
        this.clipX=this.x;
        this.clipY=b;
...
updateScrollbar:function(){
    ...
    if(this.dragging){
        if(this.rotate){
            var k=this.initialDragCoordinate+(this.chart.mouseY-this.initialMouseCoordinate);
            if(k<this.y){
                k=this.y
            }
            ...
            var a=this.initialDragCoordinate+(this.chart.mouseX-this.initialMouseCoordinate);
            if(a<this.x){
                a=this.x
            }
    ...
    if(this.rotate){
        j=this.chart.mouseY-h.y;
        if(j+h.y>this.height+this.y){
            j=this.height-h.y+this.y
        }
        if(j<0){
    ...
    j=this.chart.mouseX-h.x;
    if(j+h.x>this.width+this.x){
        j=this.width-h.x+this.x
    }
    if(j<0){
        this.resizingRight=false;
        this.resizingLeft=true;
...
if(this.resizingLeft){
    if(this.rotate){
        ...
        if(g>this.height+this.y){
            g=this.height+this.y
        }
        if(e==true){
            j=f-g
            }else{
...
var d=false;
if(this.rotate){
    if(this.clipY!=h.y||this.clipH!=h.height){
        d=true
    }
}else{
    if(this.clipX!=h.x||this.clipW!=h.width){
        d=true
    }
}
if(d){
...
handleDraggerOver:function(a){
    this.handleMouseOver()
},
handleLeftIconDragStart:function(a){
    this.resizingLeft=true
},
handleLeftIconDragStop:function(a){
    this.resizingLeft=false;
    if(!this.mouseIsOver){
        this.removeCursors()
    }
},
handleRightIconDragStart:function(a){
    this.resizingRight=true
},
handleRightIconDragStop:function(a){
    this.resizingRight=false;
    if(!this.mouseIsOver){
        this.removeCursors()
    }
...
AmCharts.ChartScrollbar=AmCharts.Class({
    ...
    init:function(){
        if(!this.cAxis){
            this.cAxis=new AmCharts.CategoryAxis()
        }
        ...
        if(this.graph){
            if(!this.vAxis){
                this.vAxis=new AmCharts.ValueAxis();
            ...
            if(!this.selectedGraph){
                this.selectedGraph=new AmCharts.AmGraph();
                this.selectedGraph.scrollbar=true
            }
            if(!this.unselectedGraph){
                this.unselectedGraph=new AmCharts.AmGraph();
...
draw:function(){
    AmCharts.ChartScrollbar.base.draw.call(this);
    if(!this.scrollbarCreated){
        this.init()
    }
    var a=this;
    if(this.rotate){
        this.cAxis.orientation="vertical"
    }else{
        this.cAxis.orientation="horizontal"
    }
    ...
    if(this.cAxis.parseDates&&!this.cAxis.equalSpacing){
        this.firstTime=this.data[0].time;
        this.lastTime=this.data[this.data.length-1].time;
    ...
    if(this.graph){
        ...
        if(!this.rotate){
            this.vAxis.orientation="vertical"
        }else{
            this.vAxis.orientation="horizontal"
        }
        this.vAxis.x=this.x;
        this.vAxis.y=this.y;
        this.vAxis.width=this.width;
        ...
        for(var e=0;e<this.data.length;
            e++){
            var m=this.data[e].axes[h.valueAxis.id].graphs[h.id].values;
            for(var c in m){
                if(c!="percents"&&c!="total"){
                    var b=m[c];
                    if(b<d){
        ...
        if(d!=Infinity){
    this.vAxis.minimum=d
}
if(j!=-Infinity){
    this.vAxis.maximum=j+(j-d)*0.1
}
this.vAxis.zoom(0,this.data.length-1);
    ...
    l.chart=this.chart;
    l.chartType=this.chart.chartType;
    l.data=this.chart.chartData;
    l.valueAxis=this.vAxis;
    l.chart=h.chart;
    l.categoryAxis=this.cAxis;
    ...
    f.chart=this.chart;
    f.chartType=this.chart.chartType;
    f.data=this.chart.chartData;
    f.valueAxis=this.vAxis;
    f.chart=h.chart;
    f.categoryAxis=this.cAxis;
...
dispatchScrollbarEvent:function(){
    if(this.skipEvent){
        ...
        if(this.cAxis.parseDates&&!this.cAxis.equalSpacing){
            if(this.rotate){
                ...
                var d=this.cAxis.minDuration();
            var e=Math.round(o/this.stepWidth)+this.firstTime;
            var k;
            if(!this.dragging){
                k=Math.round((o+h)/this.stepWidth)+this.firstTime-d
            }else{
                k=e+this.timeDifference
            }
            if(e>k){
                e=k
                }
                if(e!=this.startTime||k!=this.endTime){
                this.startTime=e;
                this.endTime=k;
                b={
                    type:"zoomed"
        ...
        if(!this.cAxis.startOnAxis){
            var m=this.stepWidth/2;
            o+=m
            }
            h-=this.stepWidth/2;
        var c=this.cAxis.xToIndex(o);
        var g=this.cAxis.xToIndex(o+h);
        if(c!=this.start||this.end!=g){
            if(this.cAxis.startOnAxis){
                if(this.resizingRight&&c==g){
                    g++
                }
                if(this.resizingLeft&&c==g){
                    if(c>0){
                        c--
                    }else{
                        g=1
    ...
    if(!this.dragging){
        ...
        this.end=this.start+this.difference
    }
    b={
        type:"zoomed"
    };
    ...
    b.start=this.start;
    b.end=this.end;
    if(this.cAxis.parseDates){
        if(this.data[this.start]){
            b.startDate=new Date(this.data[this.start].time)
        }
        if(this.data[this.end]){
            b.endDate=new Date(this.data[this.end].time)
        }
    }
    this.fire("zoomed",b)
}
...
zoomScrollbar:function(){
    ...
    c=this.data[this.start].x[this.cAxis.id];
    a=this.data[this.end].x[this.cAxis.id];
    this.stepWidth=this.cAxis.stepWidth;
    if(!this.cAxis.startOnAxis){
        var b=this.stepWidth/2;
        c-=b;
        a+=b
        }
    }
this.updateScrollbarSize(c,a)
},
maskGraphs:function(b){
    if(this.selectedGraph){
        for(var a=0;
            a<this.selectedGraph.set.length;
            a++){
            this.selectedGraph.set[a].attr({
                "clip-rect":b
            })
        }
        }
...
AmCharts.circle=function(b,a,e,d,c,f,g,j){
    if(c==undefined||c==0){
        c=1
    }
    if(f==undefined){
    ...
    if(j){
        e="r"+e+"-"+AmCharts.adjustLuminosity(e,-0.6)
    }
    var h={
        fill:e,
        stroke:f,
...
AmCharts.text=function(d,c,f,e,b){
    var a=d.text(c,f,e).attr(b);
    if(!AmCharts.isNN&&AmCharts.IEversion<9){
        a.translate(0+","+3)
    }
    if(window.opera){
        a.translate(0+","+(-2))
...
AmCharts.polygon=function(c,o,l,a,b,d,f,g,n){
    if(typeof(b)=="object"){
        b=b[0]
    }
    if(d==undefined||d==0){
    ...
    var j=AmCharts.ddd;
    var h=["M",Math.round(o[0])+j,Math.round(l[0])+j];
    for(var e=1;e<o.length;
        e++){
        h.push("L");
        h.push(Math.round(o[e])+j);
        h.push(Math.round(l[e])+j)
    }
    h.push("Z");
    return c.path(h).attr(k)
};

AmCharts.rect=function(c,p,j,a,b,d,f,g,e,o){
    if(d==undefined||d==0){
        d=1
    }
    if(f==undefined){
    ...
    if(p<0){
        ...
        n+=AmCharts.ddd;
    l+=AmCharts.ddd;
    var m=AmCharts.generateGradient(a,o);
    if(!m){
        m="#FFFFFF"
        }
        var k={
...
AmCharts.triangle=function(a,j,k,d,c,b,e,f){
    if(b==undefined||b==0){
        b=1
    }
    if(e==undefined){
...
AmCharts.line=function(a,o,m,e,d,n,b,k){
    var l="";
    if(b==1){
        l=". "
        }
    ...
    for(var f=1;f<o.length;
        f++){
        g.push(c);
        g.push(Math.round(o[f])+h);
        g.push(Math.round(m[f])+h)
    }
    return a.path(g).attr(j)
};

AmCharts.wedge=function(t,q,o,C,m,f,k,l,E,n){
    var H=Math.PI/180;
    var B=(k/f)*l;
    if(m<=-359.99){
        m=-359.99
    ...
    if(E>0){
        if(l>0){
            var G=t.path(["M",u,p+E,"L",F,D+E,"A",f,k,0,z,I,d,b+E,"L",v,s+E,"A",l,B,0,z,0,u,p+E,"z"]).attr(a)
        }else{
            var G=t.path(["M",u,p+E,"L",F,D+E,"A",f,k,0,z,I,d,b+E,"L",v,s+E,"Z"]).attr(a)
        }
        A.push(G);
        var j=t.path(["M",u,p,"L",u,p+E,"L",F,D+E,"L",F,D,"L",u,p,"z"]).attr(a);
        var g=t.path(["M",d,b,"L",d,b+E,"L",v,s+E,"L",v,s,"L",d,b,"z"]).attr(a);
        A.push(j);
        A.push(g)
        }
        if(l>0){
        var r=t.path(["M",u,p,"L",F,D,"A",f,k,0,z,I,d,b,"L",v,s,"A",l,B,0,z,0,u,p,"Z"]).attr(n)
    }else{
        var r=t.path(["M",u,p,"L",F,D,"A",f,k,0,z,I,d,b,"L",v,s,"Z"]).attr(n)
    }
    A.push(r);
    return A
    };
AmCharts.adjustLuminosity=function(e,b){
    var d=Raphael.rgb2hsb(e);
    var a=d.toString().split(",");
    var c=a[2];
    c=Number(c.substr(0,c.length-1));
    c=c+c*b;
    return(a[0]+","+a[1]+","+c+")")
};

AmCharts.putSetToFront=function(b){
    for(var a=b.length-1;
        a<=0;a++){
        b[a].toFront()
    }
    },AmCharts.putSetToBack=function(b){
    for(var a=0;
        a<b.length-1;a++){
        b[a].toBack()
    }
...
drawChart:function(){
    ...
    var k=this;
    var l=AmCharts.toCoordinate(this.marginLeft,this.realWidth);
    ...
    if(this.chartData.length>0){
        ...
        var G;
        var u=AmCharts.toNumber(this.labelRadius);
        var g=this.measureMaxLabel();
        if(!this.labelText||!this.labelsEnabled){
            g=0;
            u=0
            }
            if(this.pieX==undefined){
            O=(this.realWidth-l-P)/2+l
        }else{
            O=AmCharts.toCoordinate(this.pieX,this.realWidth)
        }
        if(this.pieY==undefined){
            N=(this.realHeight-D-A)/2+D
        }else{
            N=AmCharts.toCoordinate(this.pieY,this.realHeight)
        }
        ...
        if(!G){
            var d;
            if(u>=0){
                d=this.realWidth-l-P-g*2
            }else{
                d=this.realWidth-l-P
            }
            ...
            this.pullOutRadiusReal=AmCharts.toCoordinate(this.pullOutRadius,G);
        if(u>=0){
            G-=(u+this.pullOutRadiusReal)*1.8
        }else{
            G-=this.pullOutRadiusReal*1.8
        }
        G=G/2
        }
        if(G<this.minRadius){
    ...
    if(a>=G){
        ...
        var h=AmCharts.fitToBounds(this.startAngle,0,360);
    if(this.depth3D>0){
        if(h>=270){
            h=270
        }else{
    ...
    var z=G-G*this.angle/90;
for(var M=0;M<b;M++){
    var c=this.chartData[M];
    if(c.hidden!=true&&c.percents>0){
        var s=-c.percents*360/100;
        ...
        if(this.gradient!="none"){
            if(this.gradient=="radial"){
                var n=Math.abs(h+s/2)
            }else{
                var n=90
                }
                o=AmCharts.generateGradient(c.color,n,this.gradientRatio)
        }
        var E={
            fill:c.color,
            gradient:o,
        ...
        var m=N;
        if(this.chartCreated){
            E["fill-opacity"]=c.alpha
        }
        var C=AmCharts.wedge(this.container,y,m,h,s,G,z,a,this.depth3D,E);
        this.chartData[M].wedge=C;
        if((h<=90&&h>=0)||(h<=360&&h>270)){
            AmCharts.putSetToFront(C)
        }else{
            if((h<=270&&h>180)||(h<=180&&h>90)){
                AmCharts.putSetToBack(C)
            }
        }
        c.ix=q;
    c.iy=p;
    c.wedge=C;
    c.index=M;
    if(this.labelsEnabled&&this.labelText&&c.percents>=this.hideLabelsPercent){
        var x=h+s/2;
        if(x<=0){
            x=x+360
            }
    ...
    var v=AmCharts.formatString(this.labelText,c,this.numberFormatter,this.percentFormatter);
var f=AmCharts.text(this.container,L+e*1.5,J,v,{
    fill:this.color,
    "text-anchor":I,
    "font-family":this.fontFamily,
...
if(this.touchEventsEnabled){
    C.touchend(function(){
        handleTouchEnd(k.chartData[this.index])
    });
    C.touchstart(function(j){
        handleTouchStart(k.chartData[this.index])
    })
    }
    C.push(f);
c.labelObject=f;
...
C.hover(function(){
    k.rollOverSlice(k.chartData[this.index],true)
},function(){
    k.rollOutSlice(k.chartData[this.index])
}).click(function(){
    k.clickSlice(k.chartData[this.index])
});
this.set.push(C);
if(c.alpha==0){
    C.hide()
...
for(var M=0;M<this.chartDataLabels.length;
    M++){
    if(this.chartDataLabels[M]){
        this.chartDataLabels[M].toFront()
    }
}
this.pieXReal=O;
this.pieYReal=N;
this.radiusReal=G;
this.innerRadiusReal=a;
if(u>0){
    this.drawTicks()
}
var k=this;
if(this.chartCreated){
    this.pullSlices(true)
}else{
    var F=setTimeout(function(){
        k.pullSlices.call(k)
...
drawTicks:function(){
    for(var d=0;
        ...
        d++){
        if(this.chartDataLabels[d]){
            var f=this.chartData[d];
            var c=f.ix;
            var b=f.iy;
            ...
            var a=h.cornerx2;
            var g=h.cornery;
            var e=this.container.path(["M",this.pieXReal+c*this.radiusReal,this.pieYReal+b*this.radiusReal,"L",j,g,"L",a,g]).attr({
...
arrangeLabels:function(){
    ...
    var e=0;
    var a=0;
    for(var c=this.chartData.length-1;
        c>=0;c--){
        var f=this.chartData[c];
        if(f.labelQuarter==0&&!f.hidden&&this.chartDataLabels[c]){
            var b=f.index;
            this.checkOverlapping(b,0,true,0)
        }
    }
    d=NaN;
for(c=0;c<this.chartData.length;
    c++){
    f=this.chartData[c];
    if(f.labelQuarter==1&&!f.hidden&&this.chartDataLabels[c]){
        var b=f.index;
        this.checkOverlapping(b,1,false,0)
    }
}
d=NaN;
for(c=this.chartData.length-1;
    c>=0;c--){
    f=this.chartData[c];
    if(f.labelQuarter==2&&!f.hidden&&this.chartDataLabels[c]){
        var b=f.index;
...
for(c=0;c<this.chartData.length;
    c++){
    f=this.chartData[c];
    if(f.labelQuarter==3&&!f.hidden&&this.chartDataLabels[c]){
        var b=f.index;
        this.checkOverlapping(b,3,false,0)
    }
}
},
checkOverlapping:function(d,c,b,f){
    var a;
    var e;
    var h;
    if(b==true){
        for(e=d+1;
            ...
            e++){
            h=this.chartData[e];
            if(h.labelQuarter==c&&!h.hidden&&this.chartDataLabels[e]){
                if(AmCharts.hitTest(this.chartDataLabels[d].getBBox(),this.chartDataLabels[e].getBBox())==true){
                    a=true
                }
            }
        }
...
startSlices:function(){
    var a=this.startDuration/this.chartData.length*500;
    for(var c=0;c<this.chartData.length;
        c++){
        if(this.startDuration>0&&this.sequencedAnimation){
            var d=this;
            var b=setTimeout(function(){
                d.startSequenced.call(d)
            },a*c);
...
pullSlices:function(a){
    for(var b=0;
        ...
        b++){
        if(this.chartData[b].pulled){
            this.pullSlice(this.chartData[b],1,a)
        }
    }
    },
startSequenced:function(){
    for(var a=0;
        ...
        a++){
        if(!this.chartData[a].started){
            dItem=this.chartData[a];
            this.startSlice(dItem);
            break
        }
    }
    },
startSlice:function(c){
    c.started=true;
    var a=c.wedge;
    if(a){
        if(c.alpha>0){
        ...
        a.animate({
            ...
            translation:((-c.ix*b)+","+(-c.iy*b))
            },this.startDuration*1000,this.startEffect)
    }
},
showLabels:function(){
    for(var a=0;
        ...
        if(b.alpha>0){
            if(this.chartDataLabels[a]){
                this.chartDataLabels[a].show()
            }
            if(this.ticks[a]){
                this.ticks[a].show()
            }
...
hideSlice:function(a){
    if(isNaN(a)){
        ...
        this.chartData[a].hidden=true
    }
    this.hideBalloon();
    this.invalidateVisibility()
},
rollOverSlice:function(g,c){
    if(!isNaN(g)){
        g=this.chartData[g]
    }
...
pullSlice:function(f,c,b){
    var g=f.ix;
    var e=f.iy;
    var d=this.pullOutDuration*1000;
    if(b===true){
        d=0
        }
        f.wedge.animate({
        translation:(c*g*this.pullOutRadiusReal)+","+(c*e*this.pullOutRadiusReal)
        },d,this.pullOutEffect);
    if(c==1){
        f.pulled=true;
        if(this.pullOutOnlyOne){
            this.pullInAll(f.index)
        }
        var a={
            type:"pullOutSlice",
            dataItem:f
...
pullInAll:function(b){
    for(var a=0;
        a<this.chartData.length;
        a++){
        if(a!=b){
            if(this.chartData[a].pulled){
                this.pullSlice(this.chartData[a],-1)
            }
        }
    }
},
pullOutAll:function(b){
    for(var a=0;
        a<this.chartData.length;
        a++){
        if(!this.chartData[a].pulled){
...
parseData:function(){
    ...
    if(h!=undefined){
        ...
        for(var c=0;c<f;
            ...
            if(h[c][this.titleField]){
                this.chartData[c].title=h[c][this.titleField]
            }else{
                this.chartData[c].title=""
            }
            this.chartData[c].pulled=AmCharts.toBoolean(h[c][this.pulledField],false);
            if(h[c][this.descriptionField]){
                this.chartData[c].description=h[c][this.descriptionField]
            }else{
                this.chartData[c].description=""
            }
            this.chartData[c].url=h[c][this.urlField];
            if(AmCharts.toBoolean(h[c][this.visibleInLegendField])==false){
                this.chartData[c].visibleInLegend=false
            }else{
                this.chartData[c].visibleInLegend=true
            }
            if(h[c][this.alphaField]!=undefined){
                this.chartData[c].alpha=Number(h[c][this.alphaField])
            }else{
                this.chartData[c].alpha=this.pieAlpha
            }
            if(h[c][this.colorField]!=undefined){
                this.chartData[c].color=AmCharts.toColor(h[c][this.colorField])
            }
        ...
        for(var c=0;
            c<f;c++){
            this.chartData[c].percents=this.chartData[c].value/d*100;
            if(this.chartData[c].percents<this.groupPercent){
                g++
            }
        }
        if(g>1){
    ...
    for(var c=0;c<this.chartData.length;
        c++){
        var b;
        if(this.pieBaseColor){
            b=AmCharts.adjustLuminosity(this.pieBaseColor,c*this.pieBrightnessStep/100)
        }else{
            b=this.colors[c];
            if(b==undefined){
                b=AmCharts.randomColor()
            }
        }
        if(this.chartData[c].color==undefined){
        this.chartData[c].color=b
    }
    }
    this.recalculatePercents()
}
...
recalculatePercents:function(){
    ...
    for(var a=0;a<d;
        a++){
        var c=this.chartData[a];
        if(!c.hidden&&c.value>0){
            b+=c.value
        }
    }
    for(a=0;a<d;a++){
    c=this.chartData[a];
    if(!c.hidden&&c.value>0){
        c.percents=c.value*100/b
    }else{
        c.percents=0
        }
    }
},
handleTouchStart:function(c,a){
    if(!c.pulled){
        this.rolledOverSlice=c;
        var b=this;
        this.pullTimeOut=setTimeout(function(){
            thisobj.padRollOver.call(b)
        },100)
        }else{
        this.rolledOverSlice=undefined;
        this.hideBalloon()
        }
    },
padRollOver:function(){
    this.rollOverSlice(this.rolledOverSlice,false)
},
handleTouchEnd:function(a){
    if(a.pulled){
        this.pullSlice(a,-1)
...
removeSmallSlices:function(){
    var b=this.chartData.length;
    for(var a=b-1;a>=0;a--){
        if(this.chartData[a].percents<this.groupPercent){
            this.groupValue+=this.chartData[a].value;
...
measureMaxLabel:function(){
    ...
    for(var c=0;c<this.chartData.length;
        ...
        var a=AmCharts.text(this.container,0,0,e,{
            fill:this.color,
            "font-family":this.fontFamily,
            "font-size":this.fontSize
            });
